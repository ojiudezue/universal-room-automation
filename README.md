...
[![Version](https://img.shields.io/badge/version-3.6.0.2-green.svg)](https://github.com/ojiudezue/universal-room-automation)
...
- 🎯 **Production Ready** - v3.6.0.2 deployed
...
- **[v3.6.0.2](docs/readmes/README_v3.6.0.2.md)** - Zone presence diagnostics + BLE bypass (latest)
- **[v3.6.0.1](docs/readmes/README_v3.6.0.1.md)** - Fix zone presence, config selectors, version scheme
- **[v3.6.0-c2.9.2](docs/readmes/README_v3.6.0-c2.9.2.md)** - Fix database init + duplicate entity ID
- **[v3.6.0-c2.9.1](docs/readmes/README_v3.6.0-c2.9.1.md)** - Fix c2.9 regression + test alignment
- **[v3.6.0-c2.9](docs/readmes/README_v3.6.0-c2.9.md)** - Wire up anomaly detectors
...
- **Architecture Evolution:** v2.0 → v3.6.0.2
