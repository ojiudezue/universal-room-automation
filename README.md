...
[![Version](https://img.shields.io/badge/version-3.6.0--c2.7-green.svg)](https://github.com/ojiudezue/universal-room-automation)
...
- 🎯 **Production Ready** - v3.6.0-c2.7 deployed
...
- **[v3.6.0-c2.7](docs/readmes/README_v3.6.0-c2.7.md)** - Fix toggle switches not appearing (latest)
...
**Production Version:** v3.6.0-c2.7
...
- **Architecture Evolution:** v2.0 → v3.6.0-c2.7
