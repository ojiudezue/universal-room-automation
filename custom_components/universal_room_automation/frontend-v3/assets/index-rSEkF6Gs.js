...
`,Nm={home:Mm,house:Em,zones:Om,rooms:Dm,energy:Bm,hvac:Um,presence:km,security:Cm,safety:Hm,diagnostics:_m};function Rm(){return E.jsx("div",{dangerouslySetInnerHTML:{__html:Tm}})}function jm(S){return S.replace(/class="tab"/,'class="tab active"')}function qm({active:S}){return E.jsx("div",{dangerouslySetInnerHTML:{__html:jm(Nm[S])}})}function br(){const[S,D]=fl.useState("home");return E.jsxs(E.Fragment,{children:[E.jsx(Rm,{}),E.jsx(wm,{active:S,onChange:D,children:E.jsx(qm,{active:S})})]})}function uu(){return E.jsx("style",{children:`
      /* -- CSS Reset + Base -- */
      *, *::before, *::after {
        margin: 0;
        padding: 0;
