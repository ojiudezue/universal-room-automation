...
async def async_setup_entry(
    ...
    if entry.data.get(CONF_ENTRY_TYPE) == ENTRY_TYPE_COORDINATOR_MANAGER:
        entities = [
            ...
            # S14 REMOVED 2026-09-16: the off-phase ceiling hold is gone, so
            # its control would be an inert knob. See hvac.py for why.
...
class ZoneEntryDwellNumber(NumberEntity):
    ...
    def __init__(self, hass: HomeAssistant, entry: ConfigEntry) -> None:
        ...
        self._attr_name = "47 · Entry Wait (min)"
