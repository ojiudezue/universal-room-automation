...
#
# Universal Room Automation vv4.7.2.1
# Build: 2026-01-05
# File: __init__.py
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    if entry_type == ENTRY_TYPE_COORDINATOR_MANAGER:
        ...
        #
        # Look up the entity by unique_id (stable per D2 spec) — entity_id is
        ...
        try:
            ...
            _unique_id = f"{DOMAIN}_energy_dynamic_preset_enabled"
            _entity_id = _er.async_get_entity_id("switch", DOMAIN, _unique_id)
