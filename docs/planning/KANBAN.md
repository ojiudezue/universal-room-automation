...
_Generated: 2026-09-09T23:06:44-05:00_ - _Data commit: `5e1ef7895937`_ - _last_reconciled: 2026-09-09_
...
- **Next:** GATE = P3 read-only recorder probe (does SOC rise from solar above the reserve setpoint while CFG off). If P3 PASS: harden the plan (intentional-OFF ledger for drift P1, reserve-signature reboot adoption P2, hysteresis+dwell+lag knobs P4...
