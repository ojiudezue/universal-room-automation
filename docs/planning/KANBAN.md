...
- **Next:** Wait for HVAC-GOVERNED-EXCURSION-1 (D2+D3) to land and live-validate. Then scope S14 as a borrow kind whose ending is a BOUNDED TIMER + one-shot-per-off-phase (operator decision 2026-08-21), with a Number-entity duration knob and declare...
