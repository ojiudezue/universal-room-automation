...
_Generated: 2026-09-25T20:05:28-05:00_ - _Data commit: `5cdcba38d157`_ - _last_reconciled: 2026-09-25_
...
- **Forensic keys (4):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) STILL-REAL: no wallpanel/displayCommand consumption in URA (0 hits). Unstarted, awaiting operator ruling (card is NO-ACTION-YET).
...
### `APPLIANCE-COST-DEFERRAL-1` - Appliance cost-deferral — LG ThinQ + Rainbird start-deferral/skip — _#5 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `HVAC-EQUIPMENT-HEALTH-OBSERVABILITY-1` - HVAC equipment-health observability + closed-loop tuning from the Bryant ODU/IDU telemetry (ONE workstream, not a card flurry) — _#7 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `HVAC-PRECOOL-WINDOW-TOU-DERIVED-1` - Path A pre-cool window is summer-hardcoded [10,14) — not responsive to shoulder/winter TOU peaks (same phase-blindness we just deleted) — _#8 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **pre_planning** - approval: **explicit**
_created 2026-09-18 · updated 2026-09-19 03:10_
- **Problem / Solution:**
...
- **Forensic keys (10):**
  - `disposition_2026_09_12_sweep4`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) PARTIALLY-DONE: P7/S7 peak_held/age/count_as_of computed+published (camera_census.py:182/1172/1618); _2-suffix fresh-face shipped v5.80.0; P10/P11 dedup RESCOPED-OUT by operat...
  - `relane_2026_09_10`: Not a soak -> PRE-PLANNING. Rescoped by operator 2026-08-17 to DECAY + SUFFIX FIX (dedup dropped, probe ~0). Plan: decay/self-refresh separation targeting the 74.5% camera_unrecognized elevated time.
...
thread: **quality** - status: **planned** - approval: **implied**
_created 2026-09-25 03:20 · initial_
- **Problem / Solution:**
...
- **Next:** NO OPERATOR PICK OUTSTANDING — the A/B decision is MOOT and I have taken this card back off your queue. Option (A) was "override both phcc fixtures in conftest.py", and that is exactly what shipped on 09-20 via the leak-detector fix, whi...
- **Tags:** measure-before-build, institutional-context
- **Forensic keys (10):**
  - `measured_2026_09_23_full_suite_run`: OVERNIGHT PASS — I RAN THE WHOLE SUITE, WHICH IS THE MEASUREMENT THIS CARD HAS BEEN BLOCKED ON SINCE 2026-09-15. Command: PYTHONPATH=quality .venv-ha/bin/python -m pytest quality/tests/ -q -p no:randomly. RESULT: 194 failed, 10586 passed...
  - `DOCUMENTED_COMMAND_IS_A_TRAP_2026_09_16`: FRESH SYMPTOM, folded in rather than carded separately (adjacency sweep: this card already owns "which interpreter is the harness"). Hit live during the v5.103.4 pre-deploy gate: running the documented command produced 98 ERRORS in 0.26s...
...
### `ENVOY-STREAM-SOC-TIER-1` - The battery brain goes blind and freezes whenever both its data sources age out — give it a third, local, fast (~5-6s) source so it can keep deciding — _#4 · WSJF 2.6 · v8 tc6 u7 /e8_
...
### `HVAC-SUPPLE-SEQUENCE-1` - The ordered plan for making HVAC supple — six steps, each with a gate, run to completion rather than cherry-picked — _#6 · WSJF 2.0 · v5 tc3 u8 /e8 ⚠_
...
### `RESTART-SAFETY-DOCTRINE-1` - URA is not universally restart-safe — islands of persistence built ad hoc after each burn, no shared standard, and at least three detectors that can never reach their own threshold — _#7 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
- **Forensic keys (10):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) PARTIALLY-DONE: F2 persist + DailyCounter primitive shipped. STILL LIVE: F5 (hvac_override.py:397 _immune_holds not persisted), F8 (hvac_zones.py:631 snapshot omits override_c...
...
### `HVAC-HOT-ENTRY-LATENCY-1` - Occupant walked into an 80F zone and beat URA to the thermostat by 3 minutes — entry dwell does not care how hot the room is — _#9 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `LIGHT-SLEEP-ENTRYNONE-DIVERGENCE-1` - Canonical vs reconciler disagree on night lights in entry=none rooms during sleep (pre-existing parity break) — _#10 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **planned** - approval: **unreviewed**
...
### `EGRESS-INTERIOR-COUNT-REINFORCE-1` - Use exterior->interior egress transitions to STRENGTHEN interior count accuracy (scope 2 of egress) — _#11 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `HVAC-SETHVACMODE-CHOKEPOINT-1` - Add emit_set_hvac_mode chokepoint + migrate the 7 raw set_hvac_mode bypass sites (close the only verb-scoped write gap — 2 of 3 verbs are funnelled, set_hvac_mode is not) — _#12 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `HVAC-DEGRADED-ROOM-TRIPWIRE-1` - A zone with a permanently-disabled/setup_retry room never establishes (is_zone_hvac_established all()) -> conditioning-demand feature INERT for that zone, silently — _#13 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **planned**
_created 2026-09-17_
- **Problem / Solution:**
...
### `HVAC-COMPOSE-AWAY-THROTTLE-STORM-BLOCKER-1` - BLOCKER on enabling guest_mode_actuation — F2 compose-away throttle bypass is unconditional (12 set_temperature/hr/zone to Carrier cloud) — _#14 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **planned**
_created 2026-09-17_
- **Problem / Solution:**
...
### `HVAC-RESTORE-WRITERS-STRAND-EMPTY-NIGHT-ZONE-1` - S8/S9/S11/S13-return writers emit comfort setpoints to an empty night zone without updating _last_emitted_range — uncorrected live because D9 (intended corrector) is dormant — _#15 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **planned**
_created 2026-09-17_
- **Problem / Solution:**
...
### `EC-SOC-LADDER-FULL-WIRING-1` - Wire the 3 unconsumed SOC-ladder invariants (drain-targets, peak_buffer, inclement floor) onto the safe accessor across ~25 consumer sites — _#16 · WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
...
### `HVAC-PRESET-LOCKOUT-ESCAPE-1` - URA refuses to write a preset to a zone in `manual` — including when URA itself caused the manual, so nothing ever rescues it — _#17 · WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
...
_created 2026-09-21 02:35 · updated 2026-09-25 02:20 · refined_
- **Problem / Solution:**
...
- **Why:** This is not cosmetic log noise — it is an active loss of forensic capability, and it is blocking a sibling investigation right now. HA-CORE-RESTART-STORM-1 has 10 restarts it cannot attribute, and the supervisor journal is exactly where ...
- **Next:** DO (operator): turn Protection mode OFF on the Advanced SSH & Web Terminal add-on (Settings -> Add-ons -> Advanced SSH & Web Terminal -> Protection mode toggle). This is a single reversible toggle. WHY this is now the recommended first m...
...
- **Forensic keys (7):**
  - `measured_2026_09_25`: OVERNIGHT PASS — re-measured STILL-REAL and materially WORSE than the 09-24 reading, which raises this card's urgency rather than leaving it flat. Pulled the supervisor journal via the authenticated hassio proxy (/api/hassio/supervisor/l...
...
_created 2026-09-25 18:00 · updated 2026-09-25 20:15 · refined_
- **Problem / Solution:**
...
- **Next:** DO (operator): URA -> Coordinator Manager -> Configure -> Energy -> set "solar follow grid fallback entity" to sensor.envoy_stream_grid_power and save (UI, because an API resubmit of that large form would re-send every other energy field...
...
### `FRONT-SIDE-PTZ-CHATTER-1` - front_side_ptz fires near-continuously (21% duty, 29.5h stuck-ON, peaks 3-5am) — it is the noise source behind false circling — _#7 · WSJF 4.7 · v7 tc5 u2 /e3_
...
- **Problem / Solution:**
  - Problem: an investigation agent reported that almost all real person detections on the exterior cameras score below the 0.70 confidence cut-off, and concluded that ten cameras are effectively blind and should be retuned. The operator say...
- **Origin:** 2026-09-14 - operator — "We're seeing much higher in our infra. The settings were measure first"
- **Next:** ANSWER or DELEGATE: either share the score distribution you are seeing, or point me at a host I can query read-only. -> if the operator's read is right, this card closes and the seven cameras stay at 0.7; if the agent's is right, the swe...
- **Tags:** no-fabrication-verify, falsify-first
- **Parsimony:** [PARK] A retuning recommendation rests on a single unreproduced number the operator disputes.
- **Refs:** docs/planning/AUDIT_exterior_camera_detection_settings.md
- **Forensic keys (2):**
...
### `RECORDER-CHURN-SWEEP-URASENSORS-1` - Sweep 6-9 more URA sensors emitting per-read elapsed timestamps (same recorder write-amp class as safety_status) — _#11 · WSJF 4.3 · v6 tc5 u2 /e3_
...
### `MEMORY-ROADMAP-1` - Memory epic — forward roadmap + critique + what-survives — _#13 · WSJF 4.0 · v4 tc2 u2 /e2_
...
### `ROADMAP-UNDONE-REVIEW-1` - Review ROADMAP/VISION — surface undone-but-worthwhile — _#14 · WSJF 4.0 · v4 tc2 u2 /e2_
...
### `CAMERA-SILENT-PRODUCER-TRIPWIRE-1` - Exterior person detection can go fleet-wide silent for a day at a time and nothing notices — build the stuck-OFF mirror of the stuck-ON trip-wire we already shipped — _#16 · WSJF 4.0 · v9 tc9 u2 /e5_
...
- **Next:** APPROVE the redesign (I stopped because both reviews came back DO-NOT-SHIP, which is a mandatory pause). The build is done but does not work: it counts silence in memory, and the nightly config-entry reload storm resets that memory every...
...
### `NM-BB-CHATGUID-SELFSEND-1` - BlueBubbles v0.7.0 adds send-by-chat-GUID — lets NM target a chat by GUID instead of address, decoupling alert sends from the iMessage account so URA stops messaging the operator's own thread — _#19 · WSJF 3.3 · v5 tc3 u2 /e3_
...
### `CHATTER-RATE-VS-BURST-GAP-1` - The chatter detector cannot see the house's actual chatter — it detects BURSTS OF IMPOSSIBILITY, the real failure is SUSTAINED RATE (kitchen mmWave 731 flips/48h, only 25 impossibility events) — _#24 · WSJF 2.0 · v5 tc3 u2 /e5_
thread: **presence** - status: **waiting_operator** - approval: **explicit**
...
- **Forensic keys (11):**
  - `disposition_2026_09_12_sweep3`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) STILL-REAL (delivered, low-stakes): EV card built + applied live to ura-v8 Energy tab 2026-08-09. Dashboard artifact. next -> operator: discretionary aesthetic review of the r...
...
- **Forensic keys (5):**
  - `measured_2026_09_22`: OVERNIGHT PASS — CORRECTING A FALSE ALL-CLEAR ON THIS CARD, which is exactly the failure mode the verify-before-work rule was coined on (and this card was the coining case). What shipped here IS real and still holds: default-order collec...
...
### `HVAC-PRESET-LOCKOUT-TELEMETRY-1` - The refusal that locks URA out of a zone is recorded nowhere, so we can only measure a proxy and never diagnose it — _#3 · WSJF 6.0 · v5 tc3 u4 /e2 ⚠_
...
### `OVERRIDE-COUNT-STARTUP-AUDIT-UNTESTED-1` - override_count_today startup-audit increment site (hvac_override.py:2009) has no test anchor — _#4 · WSJF 5.0 · v5 tc3 u2 /e2 ⚠_
thread: **hvac** - status: **shipped_organic** - approval: **unreviewed**
_created 2026-09-12 14:20 · updated 2026-09-13 21:00 · initial_
- **Problem / Solution:**
  - Problem: the async_startup_audit stale-override increment of override_count_today (hvac_override.py:2009) has no mutation-anchored test — neutering it leaves the suite green. Found during the ARRESTER 7-site drill; it is NOT reachable by...
- **Why:** flagged by the ARRESTER build per Tier-3 mutation-drill discipline; captured rather than scope-crept.
- **Next:** DONE — ships with the next deploy.
...
### `ACTIVITY-LOG-BARE-SLUG-ENTITY-ID-1` - The EVSE onset path logs a bay slug in the entity_id field, and HA's recorder raises on every one of those events — _#5 · WSJF 5.0 · v5 tc3 u2 /e2 ⚠_
...
### `HVAC-COAST-OBSERVABILITY-1` - Expose EC coast/shed (energy_constraint_mode) as a first-class HVAC sensor — today it is invisible, which is why coast-driven aways cannot be attributed — _#6 · WSJF 5.0 · v5 tc3 u2 /e2 ⚠_
...
### `TOU-FILE-NO-RATE-VALIDATION-1` - A typo in the TOU rate file silently yields 0.0 rates — no validation of rates or hours — _#7 · WSJF 4.7 · v8 tc4 u2 /e3_
...
### `TOU-FILE-TOGGLE-AND-LOUD-FAILURE-1` - Make the TOU file opt-in with a toggle, and make a rejected file LOUD instead of a log line — _#8 · WSJF 4.7 · v7 tc5 u2 /e3_
thread: **energy** - status: **shipped_organic**
...
### `TOU-RATE-FILE-KEY-UNWIRED-1` - CONF_ENERGY_TOU_RATE_FILE is declared but never read — the TOU file path is hardcoded — _#9 · WSJF 4.0 · v4 tc2 u2 /e2_
thread: **energy** - status: **shipped_organic**
...
### `HVAC-ANOMALY-BLIND-1` - The HVAC anomaly detector reports "nominal" while blind on 3 of its 5 metrics — including the one that would have caught the zone-3 flap — _#10 · WSJF 3.6 · v5 tc3 u10 /e5 ⚠_
thread: **hvac** - status: **shipped_organic** - approval: **explicit**
_created 2026-08-20 14:15 · updated 2026-09-19 03:55 · refined ×3_
- **Problem / Solution:**
...
### `ROUTINE-DETECTOR-NO-DISCHARGE-1` - RegimeDetector math is faithful but the product fails its own acceptance criterion (no discharge, dead-letter ack, INFO near-noise, no consumer) — _#11 · WSJF 2.4 · v5 tc3 u4 /e5 ⚠_
...
- **Forensic keys (7):**
  - `FIXUP_2026_09_14_HOUSEHOLD_SENSOR`: SHIPPED v5.101.3 WAS INCOMPLETE — caught by live validation, not by tests. There are TWO routine-status sensors with TWO separate queries (PersonRoutineStatusSensor and the Household one). v5.101.3 bounded only the person query. LIVE PRO...
...
### `HVAC-BOOT-RAMP-AUDIT-STRANDS-PRESET-1` - The startup ramp audit writes setpoints and restores no preset, so every restart drops zones into an anonymous hold — _#12 · WSJF 2.4 · v5 tc3 u4 /e5 ⚠_
thread: **hvac** - status: **shipped_organic** - approval: **implied**
_created 2026-09-16 · updated 2026-09-19 03:55 · initial_
- **Problem / Solution:**
...
### `HVAC-MANUAL-PRESET-CONTRACT-1` - Design spec says control the thermostats via PRESETS, never raw manual setpoints — reality is zones sitting in manual for hours; do the sanctioned excursions return? — _#13 · WSJF 2.2 · v5 tc3 u10 /e8 ⚠_
thread: **hvac** - status: **shipped_organic** - approval: **unreviewed**
_created 2026-08-20 14:40 · updated 2026-09-19 03:55 · reframed_architectural_root_
- **Problem / Solution:**
...
- **Next:** OPERATOR PRE-DEPLOY CHECKPOINT (Tier 3). D1+D2a built + mutation-anchored on develop. On deploy, the acceptance test is the NUMERIC PREDICTION: zone_1 manual occupancy must fall from 69.6% toward zone_3's ~6% and the multi-hour tail (max...
...
- **Forensic keys (49):**
  ...
  - `CANARY_RUN_2026_09_16_INCONCLUSIVE_BUT_INFORMATIVE`: CANARY RUN on zone_1 (operator-approved, bounded — explicitly NOT left running all night). It did NOT confirm the collision hypothesis, and the honest verdict is INCONCLUSIVE with N=1 in each arm. Recording it precisely so nobody reads i...
  ...
  - `disposition_2026_09_12_sweep3`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) STILL-REAL — IMPORTANT: the naive fix (add preset-restore write at each restore site) is ALREADY in code (hvac_override.py:4348 _restore_after_nudge unconditional emit_set_pre...
...
### `UNEXPECTED-PERSON-IS-ON-DEDUP-MIGRATE-1` - URAUnexpectedPersonSensor.is_on uses naive camera>ble substrate — ALERT path, dedup it — _#14 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `SHADOW-IMPORT-AUDIT-1` - Audit function-local const imports that shadow module-level names (v5.84.0 incident class) — _#15 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `EC-SOC-LADDER-XVALIDATE-1` - No cross-field validation on the EC SOC ladder — inverted operator sliders can flip a gate polarity and oscillate EV pause/resume; the parked fix's trigger has now fired — _#16 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `AWAY-BLOCK-1` - House held home_day 2h with everyone away — fan->mmWave->occupancy->fan self-sustaining loop; both away paths structurally blocked — _#18 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **shipped_organic** - approval: **unreviewed**
_updated 2026-09-12 11:00_
...
### `ROOM-NAME-UNIQUE-1` - Room rename has no name-uniqueness guard — collision collapses name-keyed maps (two rooms fold into one occupancy bucket) — _#19 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **shipped_organic** - approval: **unreviewed**
...
### `EV-SENSOR-CLEANUP-1` - EV sensor surface: charge_rate dupe orphans KILLED (done); residual = wire per-plug L1 real power (Emporia) so Moes sockets read measured not the 1440W estimate — _#20 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **shipped_organic** - approval: **implied**
...
### `ARRESTER-CLOUDFLAP-FALSEPOS-1` - A Carrier cloud timeout books a phantom thermostat "override" — the arrester counts a human that was never there — _#21 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **shipped_organic** - approval: **unreviewed**
...
### `HVAC-DEMAND-KNOBS-AND-OBS-GAPS-1` - v5.103.7 shipped the conditioning-demand debounce with NO operator control (hold is module-constant only) + incomplete observability (D2 entity disabled-by-default, no `established` attr) — _#22 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **shipped_organic**
_created 2026-09-17_
- **Problem / Solution:**
...
- **Why:** Operator post-ship question: "Is there any needed observability and control for this? Did we think of that?" Audit: observability half-built (entity exists, hidden+incomplete); control thought-of then punted under ship pressure. This is ...
...
### `HVAC-AWAY-ATTRIBUTION-LEGIBILITY-1` - Make "why did this zone retreat?" LIVE-LEGIBLE — the preset REASON (vacancy/coast-duty/house-state) + coast state are invisible, so aways are unattributable at a glance (confused operator AND assistant) — _#23 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **shipped_organic**
_created 2026-09-17_
- **Problem / Solution:**
...
### `HVAC-D5-REFRAME-AND-OCCUPANCY-GATE-1` - D5 duty-cycle is occupancy-blind (forces OCCUPIED zones away during coast/shed) + its runtime_exceeded name falsely implies Bryant compressor protection — _#24 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **shipped_organic**
_created 2026-09-17_
- **Problem / Solution:**
...
### `JAYA-FAN-STILL-PHANTOM-1` - Jaya Bedroom fan-induced mmWave still-phantom held Upstairs HVAC zone (empty room) — resolved by enabling fan control so the shipped pause-recheck covers it — _#25 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `ARRESTER-LEDGER-INVISIBLE-1` - The HVAC override arrester keeps its ledger in INFO log lines, on a log that only records WARNING and above — so every arrest it makes is invisible after the fact — _#26 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **shipped_organic** - approval: **unreviewed**
_created 2026-09-15 · updated 2026-09-19 03:55 · initial_
- **Problem / Solution:**
...
### `UNLOAD-SYMMETRY-TASK-HYGIENE-1` - Setup/unload symmetry + tracked background tasks (tech-debt hardening) — _#27 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **platform** - status: **shipped_organic**
...
### `RECORDER-BLOAT-LOGFLOOD-1` - 31 GB of recorder database for only 7 days of history, on flash at 51% life — fed by three log floods — _#28 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
- **Origin:** 2026-09-15 - Operator challenged the dwell explanation, then asked for a deep recommendation on room-to-zone coupling for HVAC rather than another knob turn
- **Why:** Every previous attempt on this problem has been a knob turn, and the measured ceiling on knob turns is a 64% cut that still is not calm and costs comfort in all three zones. The reason is structural, not parametric: a 1-tick guard sits d...
- **Next:** RE-MEASURE FIRST (measure-before-build, and the parent card demanded exactly this after the sensor swap): the operator's Garage Hallway swap has LANDED — the Frigate person cam is gone from the room config, replaced by a Zigbee PIR + mmW...
...
- **Next:** DEPLOY-READY (batch): Option C (fe9ecb75f) + v1b (132d8db39) both ship-clean + orch-verified, unmerged. On a waking-hours restart I merge both -> develop -> one deploy.sh -> restart activates v5.102.1 + Option C + v1b together. Awaiting ...
- **Tags:** tier-2db
...
_created 2026-09-19 03:30 · updated 2026-09-25 02:20 · refined_
- **Problem / Solution:**
...
- **Forensic keys (9):**
  - `measured_2026_09_25`: OVERNIGHT PASS — PARKED, because the investigation has run out of observable evidence, not because it was resolved. Re-pulled the full restart ledger from the live recorder (ssh ha sqlite3 -readonly /config/home-assistant_v2.db, events J...
  - `revival_trigger`: Revive the moment a NEW unattributed restart appears in the recorder ledger — i.e. a homeassistant_stop/start pair that does NOT sit 21-125s after a URA release tag and is not operator-authorized. Concretely: at any pass, run the events ...
...
### `D1-PROTECT-FACE-BRIDGE-ADDON-1` - Build a Home Assistant ADD-ON that bridges UniFi Protect recognized-face NAMES into sensor.<cam>_face_recognized for the egress-identity producer to consume — _#2 · WSJF 3.6 · v5 tc3 u10 /e5 ⚠_
...
- **Next:** DECIDE (with operator) whether a close pair should count as ONE camera toward the 3-distinct-camera circling threshold (EXTERIOR_TRACK_CLASSIFY_CIRCLING_CAMERAS). The five pairs are now known (see resolved_2026_09_13) so no further opera...
- **Tags:** no-fabrication-verify
- **Parsimony:** [PARK] Near-duplicate camera views may inflate the distinct-camera count that triggers circling.
- **Refs:** docs/planning/VALIDATE_exterior_camera_seams.md
- **Forensic keys (3):**
  - `DISPOSITION_2026_09_14`: PARKED, merged into the PERIMETER-TOLERANCE-AND-SECTIONS-1 replay rather than measured separately. Reasoning, so this is a decision and not a deferral: THE CARD'S OWN GATE CANNOT BE MET CHEAPLY. Its `next` requires "how many historical c...
...
### `ANOMALY-SAVE-BASELINES-DICT-MUTATION-1` - save_baselines iterates the baseline dict while awaiting, so a concurrent new metric can raise mid-save and silently abandon the remaining writes — _#4 · WSJF 3.0 · v3 tc1 u2 /e2_
thread: **platform** - status: **parked** - approval: **unreviewed**
...
### `DRAIN-TARGET-DAY-STALENESS-1` - Off-peak drain target reads CALENDAR-tomorrow (solcast_tomorrow) not the peak-anchored target day, so after local midnight in the cross-midnight off-peak window it forecasts a day too far — _#5 · WSJF 2.8 · v5 tc3 u6 /e5 ⚠_
...
- **Forensic keys (11):**
  - `relane_2026_09_10`: Not a soak-in-organic -> PARKED (trip-wire). Discriminator: on the next cross-midnight class-disagreement night with arbitrage_phase in {n/a,wait} + hold_depth==allow_discharge, confirm reason names TODAY class + current off-peak. Reviva...
...
### `KP-ANNOTATION-1` - Known-person annotation + stranger-alert leg — exterior alerts annotate identity ("likely Oji"), unknown-face escalates (doorbell-automation successor) — _#6 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `EXTERIOR-DWELL-LOITER-1` - Circling classification has no dwell/loiter predicate — a 20-minute stationary watcher reads as pass_by — _#7 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `CENSUS-G6-RAW-PERSISTENCE` - G6 (PARKED, build only if needed): gate guest persistence on RAW unidentified, not the held/decayed value — _#8 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `CENSUS-GUEST-FLOOR-1` - Census blind to guests (read 4 with 10 in house) — re-admit the WiFi guest-VLAN count as a bounded FLOOR, gated to contain the FP problem that unplugged it — _#9 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `HOUSE-STATE-UTILIZATION-EPIC` - ROADMAP EPIC — give operational meaning to under-consumed house states (HOME_DAY dead, AWAY thin); rungs 2-4 unbuilt — _#10 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `PATH-ALPHA-DENOM-1` - Path-alpha away inference structurally dead when all trackers LOST/STALE — trusted denominator empties; NO existing card fixes it — _#11 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
- **Forensic keys (5):**
  - `relane_2026_09_10`: Not a soak -> PARKED (gated). Blocked on ZONE-TIER-DIVERGE-1 trace (same code region). Then consumer-enumerate tracking_status -> Tier-2-DB decomposition.
...
### `ARRESTER-BOOT-BLIND-1` - Arrester boot-window manual blindness — manual holds predating the listener are unclassifiable — _#12 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `SWEEP` - Morning sweep — _#13 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `MEMORY-ZONE-PHANTOM-WRITER-1` - Optional memory writer: zone_phantom (F2 zone-vs-house divergence has zero witnesses) — _#14 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `IOS-APP-PLAN-CARD-1` - iOS app for HAOS+URA — gated design blueprint (tracked) — _#15 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `ENTITYDESC-RUNTIMEDATA-HYGIENE-1` - EntityDescription + runtime_data hygiene (opportunistic) — _#16 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `CHATTER-CAMERA-CONFIDENCE-FLAP-1` - Camera/AI detection confidence-flap detector (STEP sibling) — _#17 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `SENSOR-MULTISTATE-FAULT-1` - Bed/multi-state sensor fault detector (STEP sibling) — _#18 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **diagnostics** - status: **parked**
_created 2026-08-18 16:45 · initial_
...
### `FAN-RECHECK-SLEEP-VETO-SCOPE-1` - Scope fan-recheck SLEEP veto to bedroom/keep-fan-on rooms (unhold empty non-bedroom rooms) — _#19 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `HVAC-PRESET-FLAP-1` - HVAC zone preset flaps home<->away every 5-15 min during occupied evenings (survives Writer-B removal) — _#20 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `FAN-LAYER-2` - FanPolicyOracle completion — RoomFanState delegation + actuate-wrap remainder (W1-W3, W8-W10) + INV-FLA-T lock — _#21 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `KHOST-2` - Operator disposition buttons + drag-between-states on the hosted board — _#22 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `EGRESS-IDENTITY-CONTROL-OBS-1` - Egress person-detection — enable/disable + observability (parsimony) — _#23 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **parked**
...
- **Forensic keys (3):**
  - `relane_2026_09_10`: Not a soak -> PARKED (folded). enable gate + observability attrs + kill-switch-inert test folded into the egress D1 Tier-2-DB fix-up/re-review. Revival: verify at egress-identity-arc close.
...
### `FAN-RECHECK-D2-DEADLOCK-1` - Fan-recheck never arms — D2 mmwave-fan demotion starves it (occupied=False before it can arm) — _#24 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **parked**
...
- **Forensic keys (7):**
  - `relane_2026_09_10`: Not a soak-in-organic -> PARKED with trigger. Discriminator = observe O1(eval_count++)/O3(ARMED)/O4(real vacate) on the NEXT organic fan-ghost episode. Revival trigger: a fan-ghost episode occurs (watch sensor.<room>_fan recheck). Per no...
  - `program`: sensor-trust-exclusion
...
### `TRANSIT-PERSON-CHECKPOINT-1` - Key TRANSIT-1 traversal checkpoints to person_id for per-person movement paths (agentic-layer feed) — _#25 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `SECURITY-CENSUS-UNKNOWN-WIRE-1` - Security unknown-person auto-lock is designed but UNWIRED to the census — _#26 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
- **Forensic keys (5):**
  - `parked_2026_09_03`: DEFER + MEASURE (operator 2026-09-03). Auto-locking on an unknown-person count is only as safe as the unknown-count false-positive/false-negative rate — wiring it before that rate is measured risks spurious locks (FP) or missed intruders...
  - `threshold_status`: PROVISIONAL — operator to confirm the >=0.9 confidence gate before build
  - `sequence`: 2
...
### `LAST-RESIDENT-EGRESS-ARM-1` - Last named resident departing (census residents_home->0) is an earlier/stronger arm-away trigger than the occupancy timeout — investigate identity-accelerated arm — _#27 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **security** - status: **parked**
...
- **Forensic keys (6):**
  - `parked_2026_09_03`: PARSIMONY PARK (operator 2026-09-03: "the house already generally knows"). The existing all-away arm already covers the need; the only marginal gain is arming a few minutes earlier via egress identity, gated on the ~0%-attach producer + ...
  - `tier`: 2-DB
  - `priority`: low
...
### `ENVOY-DRAIN-ARM-STALE-CT-1` - Drain-pause does NOT ARM a new pause under a stale (not unavailable) battery CT — a genuinely discharging battery with low SOC can be drained by the EV during a blind-CT window — _#28 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **parked** - approval: **explicit**
...
### `DEVICE-INFO-HELPER-CONSOLIDATION-1` - Consolidate the ~100 inline DeviceInfo() literals to one _*_device_info() helper per identity (the reorg collapsed only the 2 divergence-risky ones) — _#29 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **platform** - status: **parked** - approval: **unreviewed**
...
### `MENU-CONSISTENCY-1` - Config/options-flow menus are inconsistent (Zones use a dropdown to pick, CM uses a menu) — standardize on menus + consistent icon-in-label usage — _#30 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `IDENTITY-FLAPPING-FACE-VETO-1` - Fail-safe residual — a FLAPPING-frozen Frigate face sensor evades the staleness gate and can misattribute a crossing — _#31 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `DELETE-REACT-DASHBOARDS-CODE-2` - Delete the dead React dashboard CODE (dirs + deploy.sh ship) — warm/maintenance, after phase-1 unregister soaks — _#32 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `LOVELACE-DECLUTTER-MIGRATION-1` - Migrate URA v6/v8 room cards to a decluttering-card template + per-room variable map (keeps aesthetics, makes room-add near-one-line) — _#33 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `FRIGATE-LEG-NAMING-1` - Frigate live/dead leg naming is INCONSISTENT across cameras — bare _person_occupancy is live F2 on interior, dead F1 on perimeter — _#34 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `SECURITY-ENTRY-VERDICT-NAME-1` - Security entry-verdict messages name the DOOR but never the PERSON, even when the verdict already derived "known person" — _#35 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **security** - status: **parked**
...
- **Next:** PARKED — misframed (person_id not plumbed to the call sites) + sparse rate + doctrine forbids naming in the ALERT path. Revival trigger recorded. Near-term identity work belongs to SECURITY-CENSUS-UNKNOWN-WIRE-1.
...
- **Forensic keys (7):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) STILL-REAL (verbatim, lines accurate): security.py ~:1480/:1573 name door entity_id only, no person join. NOTE: its blocker EGRESS-IDENTITY-JOIN-GAP-1 was operator-DECLINED 20...
  - `tier`: 2
...
### `CONFIG-SUBENTRIES-MIGRATION-1` - Config subentries migration (flat 34-entry -> subentries) — _#36 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **platform** - status: **parked**
...
### `GUEST-IDENTITY-PHONE-LEFT-BEHIND-1` - Guest-room identity exclusion is BLE-only, so a resident without their phone arms GUEST after 30 min — _#37 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **parked** - approval: **unreviewed**
...
### `WATERLEAK-TRIO-UNKNOWN-1` - Three water-leak sensors (laundry, upstairs-guest bath, Ziri bath) all went unknown together at 08-30 16:46 — one event, safety — _#38 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **parked** - approval: **unreviewed**
...
### `PATHBETA-VESTIGIAL-1` - Path-beta infrastructure is now dead-code-like after D2b — scoped cleanup (reviewer B: do NOT bundle into PATH-ALPHA) — _#39 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **parked** - approval: **unreviewed**
_updated 2026-09-12 10:00_
...
### `KITCHEN-OVERHEAD-EXTERNAL-TURNOFF-1` - Kitchen overhead light turns off by itself — traced NOT to URA (activity log clean); orphan-context light.turn_off from an external caller (leading suspect HomeKit/app-side automation) — _#40 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `KITCHEN-NIGHTLIGHT-RANGE-MISCONFIG-1` - Kitchen night light is configured as the RANGE light (switch_tapo_wifi_kitchenrange) — likely a config mistake — _#41 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **parked** - approval: **unreviewed**
...
### `CAMERA-STUCK-MASTER-HALLWAY-1` - master_hallway camera occupancy sticks person_count=1 for hours (up to 13.9h) — recurring, D1 is catching it — _#42 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **parked** - approval: **unreviewed**
_created 2026-09-12 18:55 · updated 2026-09-12 13:15 · initial_
- **Problem / Solution:**
  - Problem: binary_sensor.master_hallway_person_occupancy asserts person_count=1 with no interior corroboration for long stretches (measured 13.9h on 2026-09-11, plus 3.0h holds on 09-09/09-10), firing the D1 camera_stuck detector 5x in 30d...
- **Why:** surfaced by the WATCHDOG-INERT-1 verify-before-work probe — D1 is correctly catching a REAL recurring stuck-camera, which is a distinct defect from the (now-closed) detector-health question.
- **Next:** MEASURE: identify the master_hallway occupancy source + why it sticks (recorder history of the binary_sensor + its device siblings around a stick event); decide the fix (exclusion / corroboration / device).
- **Tags:** no-fabrication-verify
...
### `GUEST-GATE-DOOR-IDENTITY-1` - Guest gate should consume door-identity (not just BLE room-location) — _#43 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **parked**
...
- **Forensic keys (14):**
  - `measured_2026_09_15_egress_attach`: OVERNIGHT PASS — SHARED GATE INPUT, measured read-only on the live URA DB (ssh ha sqlite3, person_entry_exit_events). THE PRODUCER IS NO LONGER DEAD, and the long-standing "attach = 0" premise these consumer cards inherited is now STALE....
  - `gate_verdict_2026_09_15`: FOUR-STEP GATE RUN -> PARK (clean park, not a skipped build). (1) VALIDITY: the card premise "cannot build the consumer until the producer JOIN lands" is PARTIALLY STALE — the JOIN did land (EGRESS-IDENTITY-JOIN-GAP-1 / EGRESS-BLE-PROVEN...
  - `parked_2026_09_15_revival_trigger`: Revive when egress identity attach is >= 50pct sustained over 14 consecutive days (re-run the same one-shot query on person_entry_exit_events), AND at least one non-resident crossing has ever been named — both are required, because resid...
...
### `APPLIANCE-CENSUS-MULTI-ROOM-POWER-SENSOR-1` - Appliance census: multi-room-same-power-sensor attribution (v1b) — _#44 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **parked** - approval: **implied**
_created 2026-09-14 · initial_
- **Problem / Solution:**
  - Problem: when two ROOM configs both declare the SAME SPAN power sensor under power_sensors, v1a census attributes the record to the FIRST-scanned room (config-order-dependent). Solution: resolve multi-room shared power sensors deliberate...
- **Why:** surfaced by v1a review A7; deferred from the v1a fix-up as v1b territory (needs the operator flow).
...
### `PERIMETER-TOLERANCE-AND-SECTIONS-1` - Measure link tolerance against real history, and decide whether some stretches of the perimeter deserve special treatment — _#45 · WSJF 2.0 · v6 tc2 u2 /e5_
thread: **perimeter** - status: **parked**
...
- **Forensic keys (5):**
  - `DISPOSITION_2026_09_14`: PARKED WITH AN EXPLICIT FIRING TRIGGER — not left open as a vague investigation. It is genuinely blocked: measuring link tolerance against an adjacency graph we KNOW was wrong would measure the wrong thing, and the corrected graph has no...
...
### `GUEST-FP-RESIDUALS-1` - Guest-FP audit residuals — path-alpha diagnostic classifier (A1, ~5 LoC) + camera-census outdoor filter (B1, latent) — _#46 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **parked** - approval: **unreviewed**
...
- **Next:** PARKED 2026-09-15 — no operator action required (the 50-episode question was answered by measurement, see measured_2026_09_15; A1 shipped v5.78.0; B1 latent with zero outdoor-zone camera person entities). Revive only on the trigger in pa...
- **Forensic keys (7):**
  - `measured_2026_09_15`: OVERNIGHT PASS — THE OPERATOR QUESTION IS NOW ANSWERED BY MEASUREMENT, so this card no longer waits on the operator (grooming: the blocker cleared). The card asked the operator to judge whether the ~50 daytime guest-ENTRY episodes since ...
  - `parked_2026_09_15_revival_trigger`: Revive B1 (camera-census room->outdoor filter) the moment a camera person entity is attached to a room whose zone is outdoor — that is the single condition that converts B1 from latent to live. Revive the card as a whole if guest entries...
  - `disposition_2026_09_12_sweep3`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) PARTIALLY-DONE: A1 path-alpha exclusion classifier shipped v5.78.0 (presence.py:5552/6219). B1 latent-only (Patio has no camera person sensor). next -> operator: judge whether...
...
### `HVAC-NIGHT-LENIENCY-DEGRADATION-DEFENSE-1` - The FULL 2-6am degradation-defense leniency for night HVAC retreat (200min, 4 discharge paths) — parked, uncork if a real occupied-bedroom sensor-degradation is observed — _#47 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `URA-CENTRAL-TICK-WHEEL-1` - One URA clock with per-consumer divisors (tick-wheel) — replace the pile of independent periodic loops with a single base tick + divisors + phase offsets — _#48 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **architecture** - status: **parked** - approval: **explicit**
_created 2026-09-16_
- **Problem / Solution:**
  - Problem: URA has ~10+ independent periodic loops at heterogeneous, individually-jittered cadences, each its own async_track_time_interval. Adding a new cadence (e.g. HVAC fast-in) means adding another bespoke timer. Solution: ONE base cl...
- **Why:** Surfaced designing HVAC fast-in (THE_BINDING_CONSTRAINT). Parked deliberately: marginal benefit today is one fast-in need, captured by a targeted 60s HVAC sub-loop instead. The tick-wheel deserves a deliberate re-architecture, not a bolt...
- **Next:** REVIVE IF either: (a) a 3rd/4th dedicated fast sub-loop need appears (energy._solar_follow + the HVAC fast sub-loop are two; a third is the evidence to generalize), OR (b) a deliberate re-architecture pass opens for coordinator timing / ...
- **Tags:** architecture, re-architecture, parked-with-trigger, prior-art-verified
- **Parsimony:** [PARK] adding each new cadence means another bespoke timer; the timing layer is a pile, not a system
- **Forensic keys (1):**
...
### `HVAC-D5-REGROUND-ON-ODU-VAR-1` - Re-ground D5 duty estimate on the real ODU Var %% / stage_status instead of the coarse 20-min hvac_action integral — _#49 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **parked**
_created 2026-09-17_
- **Problem / Solution:**
...
- **Problem / Solution:**
  - Problem (principle preserved from the deleted EC pre_cool vestige, D1): the real banking path (Path A, hvac_predict.py:_should_energy_precool) REQUIRES live PV export/surplus (net_power exporting, line 717) + 10am-2pm + summer/shoulder. ...
- **Why:** Post-delete supersession doctrine (KEEP+DOCUMENT the principle, not the naive artifact). The offset constant CONF_ENERGY_CONSTRAINT_PRECOOL_OFFSET is tombstoned in-code pointing here. NOT highest priority (operator) - a design axis, not ...
- **Next:** PARKED. Revival trigger = summer billing / a measured hot-day-with-low-morning-SOC where the house ran hot into peak because Path A could not pre-cool (no surplus). Measure-first: how often does low-morning- SOC + hot-forecast co-occur? ...
...
_created 2026-09-19_
- **Problem / Solution:**
  - Split out of ROOM-CONFIG-SAVE-FULL-RELOAD-STALL-1 planning (2026-09-19). Today refresh_subscriptions re-evaluates the whole house claim map; a per-room refresh_subscriptions(entry_id=...) would let a single- room change touch only that r...
- **Why:** the aggressive D2 the operator named was falsified as unnecessary for the stall fix; preserved here as a genuine (but lower-value) perf/cleanliness improvement rather than dropped.
- **Next:** PARKED. Revisit if D1 leaves residual house-wide substrate work on suppressed saves.
- **Tags:** presence, substrate, reload, performance, parked
- **Forensic keys (1):**
...
### `HVAC-ROLLOVER-DURABLE-DATE-ORDERING-1` - The daily short-cycle sample is now saved durably but its date stamp is not — an unclean restart in the same tick can still double-count one day — _#53 · WSJF 1.6 · v4 tc2 u2 /e5_
thread: **hvac** - status: **parked** - approval: **unreviewed**
_created 2026-09-16 04:00 · initial_
- **Problem / Solution:**
  - Problem: we just fixed the HVAC short-cycle detector so the one measurement it takes each day gets written to disk immediately instead of being thrown away on the next restart. But there are TWO things that need saving — the measurement ...
- **Origin:** 2026-09-16 - Review A MEDIUM-1 on the HVAC-ANOMALY-BLIND-1 residual-B cycle, confirmed independently by the orchestrator against hvac.py:1641-1658 (periodic snapshot gated on a 5-cycle counter) and hvac.py:972-988 (boot restore reads the...
- **Why:** the fix-up round shrank this window from up to ~25 minutes to the remainder of one decision cycle, which is a ~1000x reduction and the right stopping point for an unattended change. It did not close it. Recording the residual explicitly ...
- **Next:** PARKED with a revival trigger, deliberately — do not schedule it on its own. REVIVE IF any of: (a) a metric_baselines read shows short_cycle_rate sample_count advancing by more than 1 per zone per day (the observable signature of the dou...
- **Tags:** tier-2
- **Parsimony:** [SIMPLIFY] the durable sample and the durable date advance at different moments, so a kill between them re-records a day that was already counted
- **Refs:** hvac.py:4160-4181 (the shipped ordering + nudge); hvac.py:1641-1658 (periodic snapshot, 5-cycle gate); hvac.py:4463-4474 (teardown snapshot)
- **Forensic keys (1):**
...
### `GAP-A-CENSUS-HOLE-1` - Path-alpha veto blocked by forgotten-phone BLE via census_count clause — replace with camera-provable-only evidence (face_recognized_count) — _#54 · WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
thread: **presence** - status: **parked** - approval: **implied**
...
- **Forensic keys (4):**
  - `relane_2026_09_10`: Not a soak -> PARKED (gated). Build on feature/path-alpha AFTER its D1-D9 land; covered by the same 3 framing-disjoint reviews + one deploy.
...
### `STUCK-SENSOR-1` - Flapping mmWave evades stuck-exclusion; fix via corroboration-gated exclusion at the ROOM tier — _#55 · WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
thread: **presence** - status: **parked** - approval: **explicit**
...
### `XCORR-1` - Burst-demotion for isolated single-camera night alerts (was: cross-engine corroboration gate) — _#56 · WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
thread: **perimeter** - status: **parked** - approval: **explicit**
_updated 2026-08-23 14:30_
...
- **Forensic keys (5):**
  - `relane_2026_09_10`: Not a soak -> PARKED. Deferred build: burst-demotion (first alert full severity; repeats demoted when isolated+uncorroborated+night); channel reduction folded into CONSOL-1. Revival: CONSOL-1 or a burst-demotion cycle.
...
### `ARREST-SUNSET-1` - Temp Arrester Override does not sunset on away/vacation (only sleep) — _#57 · WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
...
### `HVAC-BASELINE-MAXSAMPLES-1` - HVAC anomaly baselines never forget — an accumulator matured on August cooling will misjudge October; scope a bounded/windowed sample count into the shared detector — _#58 · WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
thread: **hvac** - status: **parked** - approval: **explicit**
...
### `EXTERIOR-GUEST-EGRESS-1` - Exterior->interior guest admission: plumb identity through the egress event so an UNKNOWN person crossing inside can corroborate guest — _#59 · WSJF 0.8 · v5 tc3 u2 /e13 ⚠_
thread: **presence** - status: **parked** - approval: **explicit**
...
### `EVSE-SOLAR-STOP-CONDITIONS-1` - Solar sessions cannot tell "the car is done" from "the sun is still out" — a finished or unplugged car holds its claim until the fleet conditions end — _#60 · WSJF 0.8 · v5 tc3 u2 /e13 ⚠_
thread: **energy** - status: **parked** - approval: **implied**
...
### `HVAC-EXCURSION-RESTORE-UNIFIED-1` - Unify HVAC excursion restore — auto-release sweep (D1), setpoint-writer governance gate (D2), manual-preset recovery (D3, kill-switch OFF), off-phase ceiling governance (D4) — _#61 · WSJF 0.8 · v5 tc3 u2 /e13 ⚠_
...
### `BREAKER-GRIDCAP-STALE-TELEMETRY-1` - Breaker-guard + grid-cap behavior under STALE (not unavailable) Envoy telemetry — needs a proper design, split out of the Envoy shared-staleness cycle after it over-corrected — _#62 · WSJF 0.8 · v5 tc3 u2 /e13 ⚠_
...
### `EGRESS-EXIT-IDENTITY-BACKFILL-1` - Name who EXITED by backfilling the crossing row when their BLE goes not_home (~5 min after the door crossing) — _#63 · WSJF 0.8 · v5 tc3 u2 /e13 ⚠_
thread: **identity** - status: **parked** - approval: **explicit**
...
- **Problem / Solution:**
  - Problem: the add-on that is supposed to stream live Envoy data into the house over MQTT is configured to talk to a machine that does not exist. It has been sitting in a permanent error state, restarting forever and producing nothing, and...
- **Origin:** 2026-09-25 - operator: "Not sure its correctly configured. Read its repo to get how to do this right."
- **Why:** Operator asked for a config audit against the upstream repo. Found exactly one wrong value, verified by probing both addresses rather than by reading the config alone.
- **Next:** DO (operator): set ENVOY_USE_HTTPS back to TRUE (it regressed to false during the host edit); keep ENVOY_HOST=192.168.11.190, which is correct and faster than the old address; restart the add-on -> I then verify it reaches "started" and ...
...
- **Forensic keys (8):**
  - `resolved_2026_09_25`: RESOLVED AND LIVE-VERIFIED END TO END. Sequence: operator set ENVOY_HOST to 192.168.11.190 (Envoy ETHERNET leg — correct, and measurably better than the old address: 0.57ms, https /info 200 in 0.149s vs 0.41s, on-link via enp4s0.3 /22), ...
  - `status_note`: Add-on fix COMPLETE. The URA-side consumer work (trust/precedence of this fast feed against the existing Envoy source) remains a SEPARATE cycle and is deliberately not folded in here — see ENVOY-FAST-FEED-URA-CONSUMER-1.
  ...
  - `round2_2026_09_25_https_flag_regressed`: OPERATOR FIXED ENVOY_HOST -> 192.168.11.190 (the Envoy's ETHERNET interface; the Envoy is genuinely dual-homed) BUT THE ADD-ON STILL FAILS. Root cause found and CONFIRMED IN THE LOG, not inferred. THE IP CHANGE WAS CORRECT AND IS AN IMPR...
...
_created 2026-09-14 01:50 · updated 2026-09-25 02:35 · initial_
- **Problem / Solution:**
...
- **Forensic keys (12):**
  - `RESIDUAL_DIAGNOSED_2026_09_25`: OVERNIGHT PASS — the residual from 09-24 is now DIAGNOSED, it is NOT a defect in this trip-wire, and this card CLOSES on met-with-a-residual with the residual handed to a card that already exists. The 09-24 soak-exit left one cheap quest...
  - `BUILT_2026_09_14`: BUILT @ feature/camera-stuck-sensor-tripwire — in review, not deployed. NEW `camera_stuck` evaluator in the optimizer cycle. Deliberately a SEPARATE check from sensor_health rather than a threshold tweak to it: sensor_health is ROOM-keye...
  ...
  - `organic_evidence_2026_09_24`: SOAK-EXIT DISPOSITION, one-shot query against the live URA DB (ssh ha sqlite3 -readonly universal_room_automation.db). VERDICT: MET-WITH-A-RESIDUAL, and the residual is big enough that I am returning this to review rather than closing it...
  - `sharp_problem_2026_09_24`: The stuck-ON trip-wire fires, but it detected 2 camera_stuck events while 17 camera motion sensors sat stuck ON for ~19 hours. Under-detection at fleet scale, plus the quarantine arm is still shadow-only, so nothing is acted on even when...
  - `links_note_2026_09_24`: Evidence shared with PERIMETER-DETECTION-WENT-DARK-1 — the same 17 stuck-ON *_motion_3 entities are the occupancy-poisoning risk recorded there.
...
### `OVERNIGHT-PASS-NO-LOG-REACH-1` - The overnight pass cannot read HA logs, so every log-based investigation silently stalls — _WSJF 9.0 · v7 tc7 u4 /e2_
thread: **platform** - status: **done** - approval: **unreviewed**
_created 2026-09-15 03:45 · updated 2026-09-21 02:30 · refined_
- **Problem / Solution:**
  - Problem: several cards on this board can only be advanced by reading Home Assistant log lines (the reload-storm trigger hunt is the live example, and its debug logging is already armed and waiting to be read). The unattended overnight pa...
- **Origin:** 2026-09-15 - overnight pass tried to run the armed reload-storm log probe and had no route to the logs
...
- **Forensic keys (6):**
  ...
  - `RESOLVED_2026_09_21`: RESOLVED, AND THE 2026-09-20 REOPEN WAS ITSELF WRONG — I am retracting a retraction, which is worth stating plainly. On 09-20 I reopened this card and called the 09-18 resolution a "false all-clear". That reopen tested four routes (`ha c...
  - `MCP_STATUS_2026_09_21`: Separate, still-open detail, recorded so it is not mistaken for the log gap: the home-assistant MCP server genuinely does fail in this environment. ha-mcp 8.5.0 crashes at startup with TypeError: AsyncConnectionPool.__init__() got an une...

### `AGGREGATION-ENTITY-ADDED-THREAD-SAFETY-1` - AggregationEntity.async_added_to_hass off-loop async_create_task (house-wide, HA 2027 deprecation) — _WSJF 2.8 · v7 tc5 u2 /e5_
thread: **platform** - status: **done** - approval: **implied**
_created 2026-09-15 · updated 2026-09-20 03:30 · refined_
- **Problem / Solution:**
...
- **Next:** CLOSED 2026-09-20 (refuted). No action here. The live successor is PROPERTY-GETTER-SIDE-EFFECT-TASKS-1.
- **Tags:** tier-2
- **Forensic keys (6):**
  - `BLOCKED_2026_09_16`: Overnight pass could not advance this card, and the reason is now concrete rather than a scheduling miss. The measurement this card requires is a boot traceback from the HA CORE LOG, and tonight ssh to the HA host was DOWN for the whole ...
  - `settled_2026_09_20`: CLOSED BY DIRECT SOURCE READ — the card's own next said to settle it this way if the log stayed silent, and it did. Two things happened tonight. FIRST, THE BLOCKER WAS STALE: this card was blocked_by OVERNIGHT-PASS-NO-LOG-REACH-1 on the ...
  ...
  - `ASK_WITHDRAWN_2026_09_19`: THE OPERATOR ASK ON THIS CARD IS WITHDRAWN — I could run it myself, and I did, and it came back NEGATIVE. The card asked you to restart HA inside your evening window and tell me, so I could grep the core log before the traceback rotated ...

### `STUCK-MOTION-FROZEN-ON-BLINDSPOT-1` - Stuck-sensor defense is blind to a MOTION/PIR sensor frozen ON (offline holding last state) — trusted anchor + unavailable-only staleness let a phantom hold the house occupied — _WSJF 3.0 · v7 tc4 u4 /e5_
thread: **presence** - status: **done**
_created 2026-09-18 · updated 2026-09-19 05:10_
- **Problem / Solution:**
...
- **Next:** DONE — refuted. Real cause = Jaya radar false-positive in empty room (see JAYA-RADAR follow-up).
- **Tags:** presence, occupancy, stuck-sensor, staleness, bug-class-7, incident, refuted
...
- **Forensic keys (9):**
  ...
  - `REFUTED_2026_09_19`: CLOSED REFUTED (operator directive: close refuted, drop leak-class). Recorder forensics overturned the premise on every count. (1) The originally-named entity binary_sensor.upstairs_hall_motion_3 is platform=frigate (a CAMERA motion obje...
  - `LANE_FIXED_2026_09_19`: BOARD-HYGIENE DEFECT FIXED, and it is the silent kind. This card carried NO status field at all, so the renderer could not lane it — it fell into the bucket nobody reads and was invisible to every lane view while looking complete in the ...
  - `prior_next_2026_09_18`: 'BUILD (implied approval): verify PIR-stuck-on leak is legit + verify camera-motion-not-occupancy claim; if leak real, the built D1 corroboration-demote already targets CONF motion sensors (incl. PIR) — re-scope to PIR, drop camera D1pri...

### `URA-CONFIG-ENTRY-RELOAD-STORM-1` - The COORDINATOR-MANAGER (CM) config entry reloads itself ~5x/night with no operator change — 118 coordinator entities blip unavailable each time (root of the onset early-release + parent-reload watchdog risk) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **explicit**
_created 2026-09-10 00:50 · updated 2026-09-19 03:30 · initial_
- **Problem / Solution:**
...
- **Next:** CLOSED 2026-09-19 (refuted). No action. The live successor is HA-CORE-RESTART-STORM-1.
...
- **Forensic keys (18):**
  - `MEASURED_2026_09_18`: THREE findings, and the card is now UNBLOCKED — its blocker OVERNIGHT-PASS-NO-LOG-REACH-1 is closed because a working log route exists via the HA REST API supervisor proxy using the HA_TOKEN in homelab-automation/.env. (1) DEBUG WAS STIL...
  - `REMEASURED_2026_09_17`: Recorder-authoritative re-measure (ura_setup_duration started_at + coordinator_manager running->not_initialized transitions; significant_changes_only=false). Last 48h = 8 setups: overnight storm 09-15->16 = 3 (22:56/00:02/01:15), 09-16->...
  - `measured_2026_09_15_self_issued_reloads`: OVERNIGHT PASS — THE STATIC HALF OF THIS CARD next IS NOW ANSWERED, and the answer is a clean NEGATIVE that removes the most attractive suspect. The next asked me to "grep the codebase for self-issued homeassistant.reload_config_entry" a...
  - `probe_blocked_2026_09_15`: OVERNIGHT PASS — PROBE ATTEMPTED AND BLOCKED, card NOT advanced. This card next action is a log read ("ha_get_logs core around one blip for reload/Unloading/Setting up") and the debug logging is already armed on the live instance, so thi...
  - `verify_2026_09_12`: APPROVED -> verify-before-work: PREMISE NO LONGER ACUTE. MEASURED (10d recorder, CM-hosted entity unavailable-transitions = parent reloads): ~5x/night on 09-08(6)/09-09(5) COLLAPSED to 1 reload/59h after 09-10 00:06 CDT (coincides with t...
  - `disposition_2026_09_12b`: APPROVED to work (operator board). Per verify-before-work: confirm the premise is STILL real (ground truth) BEFORE acting; if stale/already-done/moot, record + re-surface rather than build. Lane moves with the verification outcome.
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) STILL-REAL: suppress-keys gate exists (__init__.py:6664/7489; card's 7280/7538 refs drifted). v5.99.0 closed options-save trigger but storm persists via a different trigger; d...
  ...
  - `MEASURED_2026_09_19`: REFUTED for the current regime, with an authoritative 1:1 ledger — and a BIGGER problem surfaced in its place. Three reads, all read-only. (1) THE LOG ROUTE WORKS but the DEBUG ARMING WAS GONE AGAIN: 20,000 core-log lines covering 2026-0...
  - `INVESTIGATION_EXIT_2026_09_19`: REFUTED-but-fertile. Premise (URA reloads its own config entry ~5x/night, unattended) is refuted for the current regime by the 1:1 restart<->setup ledger above. The surfaced different problem = 8 whole-HA restarts in 20h -> new card HA-C...
...
### `FRESHNESS-FALSE-AWAY-DOWNSTREAM-1` - Freshness-gate false-AWAY residuals — perimeter escalation / NM quiet-hours inversion / guest-gate cancel (daytime-only after sleep-guard) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done**
_created 2026-09-18_
- **Problem / Solution:**
  - Origin: the context-wide blast-radius scan for STUCK-MOTION-FROZEN-ON-BLINDSPOT-1 (the occupancy freshness gate). A freshness demote that flips zone->house AWAY has three M-harm downstream consumers: (3) perimeter alert severity escalati...
- **Why:** blast-radius scan flagged 3 M-harm consumers of a freshness false-AWAY; nighttime cases removed by the sleep-guard, so this is a daytime residual follow-up, captured not scope-crept.
- **Next:** REVIEW: reviewers judge whether the daytime residual needs a pre-ship guard; else parked until the trigger fires.
- **Tags:** presence, occupancy, freshness-gate, security, perimeter, nm, guest, blast-radius
- **Forensic keys (2):**
  - `dropped_2026_09_19`: DROPPED — child of STUCK-MOTION-FROZEN-ON-BLINDSPOT-1, which closed REFUTED (the whole freshness-gate premise was falsified; real cause = Jaya radar false-positive, not a stuck sensor). No freshness gate shipping, so these downstream res...
...
### `ZIRI-PRESENCE-SENSOR-DEAD-1` - Ziri Bedroom presence redundancy degraded — ziri_3_presence mmWave is dead (never fired 7 nights), leaving one live mmWave with 360+min overnight OFF stretches — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done**
_created 2026-09-16_
- **Problem / Solution:**
...
- **Forensic keys (1):**
  - `REFUTED_2026_09_16`: CLOSED — operator ground truth: ZIRI IS NOT AT HOME. ziri_3_presence "never fired all week" and mmwave_zigbee_ziribedroom's 360-416min OFF stretches are an EMPTY ROOM behaving correctly, NOT a dead sensor and NOT redundancy degradation. ...
...
- **Next:** CLOSED 2026-09-15 (REFUTED — see measured_2026_09_15). No further action on this card; any residual Path-B guest-room false-arm is tracked on GUEST-FP-RESIDUALS-1. SUPERSEDED next was: MEASURE (joined with CENSUS-FACE-MISS-WATCH-1): reco...
...
- **Forensic keys (4):**
  - `measured_2026_09_15`: OVERNIGHT PASS — ONE-SHOT PROBE RUN, PREMISE REFUTED, CARD CLOSED. The card claimed the flip-instant census split "is NOT historized, so the term cannot be pinned post-hoc" — that claim is WRONG: table `census_snapshots` historizes exact...
...
### `CIRCLING-SEVERITY-1` - A "circling" exterior person produced alert_count=0 — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **perimeter** - status: **done** - approval: **unreviewed**
...
- **Forensic keys (9):**
  - `disposition_2026_09_15_ack`: DONE — operator acknowledged this work on the board (ack CIRCLING-SEVERITY-1), and verification confirms it is genuinely complete, not just accepted. The card's `next` was STALE: it still read as unshipped follow-on work, but the perimet...
...
### `CAMERA-PTULTRA-NOT-IN-PERIMETER-1` - 'Madrone PT Ultra' is a real camera with person detection that is NOT in URA's perimeter list — _WSJF 7.0 · v7 tc5 u2 /e2_
thread: **perimeter** - status: **done**
_created 2026-09-13 23:05 · updated 2026-09-14 03:35 · refined_
- **Problem / Solution:**
  - Problem: the operator named a ring position "Madrone PT Ultra/Reolink hub". There IS a camera called Madrone PT Ultra in Home Assistant, with its own Frigate person detection (binary_sensor.madroneptultra_person_occupancy), but it is NOT...
- **Origin:** 2026-09-13 - operator ring slot named "Madrone PT Ultra/Reolink hub"; agent silently mapped it to reolinkstudybporchptz without verifying
- **Next:** APPROVE me to add camera.madroneptultra to perimeter_cameras (config-only, no code, no tier), or add it yourself in the integration options — BUT read cross_finding_2026_09_14 first: the camera has never fired a single Frigate event beca...
- **Tags:** no-fabrication-verify
- **Parsimony:** [BUILD] A named ring position may refer to a camera URA does not watch.
- **Refs:** .storage/core.config_entries perimeter_cameras
- **Forensic keys (6):**
  - `ANSWERED_2026_09_14`: OPERATOR CONFIRMED IT IS A SEPARATE CAMERA: "There is a missing camera in this loop I had left out. There are 2 reolinks." The corrected ring places `madroneptultra` at position 5 (between utilities_ptz and pool_equipment) and `reolinkst...
  ...
  - `WRONG_ENTITY_ADDED_2026_09_14`: OPERATOR ACTED BUT THE WRONG ENTITY LANDED — verified, not assumed. perimeter_cameras went 9 -> 10, but the new entry is `camera.study_a_closet_reolink_reolink_home_hub_high_resolution_channel`, NOT `camera.madroneptultra`. THAT ENTITY H...
  - `TWO_STEPS_NOT_ONE`: I previously told the operator this card was "down to one config action". WRONG — it is two, and the second decides whether the camera is useful at all: (1) CONFIG: swap the entity (remove the Home Hub channel, add camera.madroneptultra)...
  - `cross_finding_2026_09_14`: CAUTION — MEASURED, AND IT CHANGES THIS CARD'S RECOMMENDATION. While probing CAMERA-ZERO-FIRE-DETECTORS-1 I read Frigate 2's own event DB directly (192.168.13.18, read-only): `MadronePTUltra` has produced **ZERO events of ANY label, ALL ...

### `CAMERA-ZERO-FIRE-DETECTORS-1` - Three exterior person detectors fired ZERO times in 8 days — two of them are in the new seam ring — _WSJF 4.0 · v6 tc4 u2 /e3_
thread: **perimeter** - status: **done**
...
- **Next:** PICK per camera (all three are homelab/physical calls, none is a URA code change): (1) ReolinkStudyBPorchPTZ — APPROVE moving its detect role onto h264Preview_01_main (640x480 -> main res) to restore recall, or DECIDE it stays low-priori...
- **Tags:** measure-before-build, no-fabrication-verify
- **Parsimony:** [BUILD] Two cameras the seam ring depends on have not produced a single detection in eight days.
- **Refs:** docs/planning/AUDIT_exterior_camera_adjacency_probe.md; docs/planning/AUDIT_exterior_camera_detection_settings.md
- **Forensic keys (6):**
  - `CLOSED_2026_09_15`: DONE — all three answered by the operator, and TWO ARE NOW MEASURABLY FIXED. Not one of the three is a URA defect; the card's value was proving that and getting the ring picture right.
  ...
  - `measured_2026_09_14_frigate_host`: ONE-SHOT READ-ONLY PROBE against the AUTHORITATIVE source — Frigate 2's own event DB and /api/stats on 192.168.13.18 (the card's named discriminator). Read-only sqlite + the internal stats endpoint; nothing changed on the host. HEADLINE:...
...
_created 2026-09-14 00:45 · updated 2026-09-14 03:05 · refined_
- **Problem / Solution:**
  - Problem: when URA detects that someone's routine has changed it is supposed to tell the operator, either immediately or in a weekly digest. Over four months it recorded 462 such events and sent NOTHING — both the queue that feeds the wee...
- **Origin:** 2026-09-14 - found while measuring ROUTINE-DETECTOR-NO-DISCHARGE-1 — the consumer check turned up two empty tables
- **Next:** NONE — closed REFUTED. The feature works as configured (weekly_digest). If the operator wants per-event routine notifications instead of a Sunday digest, that is a Select change (select.py:330, ura_coordinator_manager_routine_change_noti...
- **Tags:** no-fabrication-verify, falsify-first
- **Parsimony:** [DROP — premise refuted by measurement; the path is alive and sending weekly.] A notification path with handlers wired has produced zero output across 462 events.
...
- **Forensic keys (4):**
  ...
  - `claim_marked_WRONG_2026_09_14`: The card's own premise — "sent NOTHING", "the log of notifications actually sent [is] completely empty" — is WRONG, and `evidence_2026_09_14` above is superseded. It read the two EMPTY tables as proof of a dead path without checking the ...
  - `measured_2026_09_14`: ONE-SHOT READ-ONLY TRACE (no code changed). Both empty tables are EXPECTED under the live configuration, not symptoms: (1) MODE. `_dispatch_regime_notification` (notification_manager.py:5169) branches on CONF_ROUTINE_CHANGE_NOTIFICATION_...
  - `lesson_2026_09_14`: Two empty tables were read as one finding; neither was the table that records the outcome. This is the discriminating-acceptance-criterion rule (CLAUDE.md "acceptance criteria must DISCRIMINATE"): "queue is empty" is equally the signatur...
...
thread: **perimeter** - status: **done**
_created 2026-09-13 23:05 · initial_
- **Problem / Solution:**
  - Problem: the operator gave a left-to-right ring of the exterior cameras AND, separately, wrote notes on individual seams saying which cameras sit between which. Those two pieces of the same document disagree about where the pool-equipmen...
- **Origin:** 2026-09-13 - operator — "Don't skim" (after the agent under-read the same document twice)
- **Next:** CONFIRM the ring order around the pool: is it utilities_ptz > pool_equipment > Reolink/PT-Ultra > hot_tub (the swap, which matches your seam notes #6 and #21), or utilities_ptz > Reolink/PT-Ultra > pool_equipment > hot_tub (as written)? ...
- **Tags:** no-fabrication-verify, falsify-first
- **Parsimony:** [BUILD] Two of three newly-added seams may be wrong.
- **Refs:** docs/planning/VALIDATE_exterior_camera_seams.md
- **Forensic keys (2):**
  - `RESOLVED_2026_09_14_MY_HYPOTHESIS_WAS_WRONG`: I proposed that pool_equipment and the Reolink slot were SWAPPED, scoring that 6/8 against the operator's own between-notes versus 4/8 for the ring as written. THE SWAP WAS THE WRONG EXPLANATION. The operator supplied the actual cause: t...
  - `evidence_2026_09_13`: Scored both orderings against the operator's four explicit "X is between them" notes. RING AS WRITTEN (... utilities_ptz > reolinkstudybporchptz > pool_equipment > hot_tub ...) scores 4/8 and CONTRADICTS note #21 outright: the operator w...

### `EGRESS-CAMERA-LIST-STALE-5-NOT-3-1` - Live egress_cameras is FIVE (adds garage_a, garage_b) but the const and its derived list assume THREE — _WSJF 4.7 · v7 tc5 u2 /e3_
thread: **perimeter** - status: **done**
_created 2026-09-13 23:05 · initial_
- **Problem / Solution:**
  - Problem: URA is configured with five egress cameras — the front entry, doorbell, front-door aerial AND both garage cameras. But the code that works out which perimeter cameras sit next to an egress only ever considers the first three; th...
- **Origin:** 2026-09-13 - found while verifying the operator's ring against live config — perimeter_cameras(9) and egress_cameras(5) read from .storage
- **Next:** DONE — semantics captured in code + tests. Garage cameras stay egress, stay out of the exterior ring.
- **Tags:** no-fabrication-verify
- **Parsimony:** [BUILD] Two configured egress cameras are invisible to the egress-adjacency derivation and absent from the seam graph.
- **Refs:** custom_components/universal_room_automation/const.py:1942; quality/tests/perimeter/test_seam_graph_invariants.py
- **Forensic keys (2):**
  ...
  - `ANSWERED_2026_09_14`: OPERATOR RULING: the garage cameras ARE egress, but they are INTERIOR — "the garage cameras are in the garage not outside so they do not normally see external people but they do see crossings into the house". The other three sit OUTSIDE ...
...
### `OPTIMIZER-PAGING-PRIMITIVE-1` - Optimizer paging reads primitive — alerts are Tier-1 template strings, not the LLM tier's reasoning — _WSJF 2.6 · v7 tc4 u2 /e5_
thread: **optimizer** - status: **done** - approval: **explicit**
...
- **Forensic keys (12):**
  - `disposition_2026_09_15_ack`: DONE — operator acknowledged this work on the board (ack OPTIMIZER-PAGING-PRIMITIVE-1), and verification confirms it is genuinely complete, not just accepted. The card's `next` was STALE: it still read as unshipped follow-on work, but th...
...
_created 2026-08-31 19:15 · updated 2026-09-13 21:40 · initial_
- **Problem / Solution:**
...
- **Forensic keys (4):**
  - `disposition_2026_09_13`: OPERATOR APPROVED the 4 edits -> verify-before-work ran FIRST and found NO EDITS NEEDED. Verdict ALREADY-DONE (3 of 4) + MOOT (the 4th) + CARD-WAS-WRONG (premise). Closing without applying anything; no restart required. Live .storage rea...
  - `disposition_2026_09_12_sweep3`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) CANNOT-VERIFY-STATICALLY: the 4 config edits (repoint kitchen_2->kitchen_3, up_guest_room_2->_3, MBR fan, CM contact->_contact_2; remove Jaya door_sensor) live in HA .storage,...
...
### `OLLAMA-CONSUMER-AUDIT-1` - Ollama eating RAM — audit every LLM/vision integration for a dependency before stopping it — _WSJF 13.0 · v5 tc6 u2 /e1_
thread: **infra** - status: **done**
_created 2026-09-13 20:50 · updated 2026-09-13 21:15 · initial_
- **Problem / Solution:**
  - Problem: the local Ollama server was consuming a lot of memory and the operator wanted to shut it down, but could not risk breaking whatever depended on it — the suspicion was that the camera-image analysis integration (LLM Vision) was q...
- **Origin:** 2026-09-13 - operator — "Check the Openai, Claude and LLM vision integrations… Probably vision. That way I can be cleared to stop ollama"
- **Why:** Stopping a service that something silently depends on produces a failure that looks unrelated days later. Cheap to verify up front, expensive to diagnose after.
- **Next:** DONE — operator cleared to stop Ollama. If kept: set keep_alive 0 or 300 instead of -1.
- **Tags:** no-fabrication-verify
- **Parsimony:** [BUILD] Is any live integration calling the Ollama server before we stop it?
- **Refs:** /Users/okosisi/ha-config/.storage/core.config_entries; custom_components/universal_room_automation/domain_coordinators/optimization_llm.py:303
- **Forensic keys (2):**
  - `closed_2026_09_13`: CLOSED — operator stopped the Ollama service after this audit cleared it ("Kill the card for Ollama. I just stopped the service"). Outcome realised: RAM reclaimed on 192.168.13.62, no consumer broken. If anything later reports a missing ...
  - `findings_2026_09_13`: CLEARED TO STOP — no consumer found. LLM Vision (both entries) uses OpenAI gpt-5-mini cloud, NOT Ollama (operator's hypothesis REFUTED). OpenAI / Anthropic / Google entries are all cloud. Both Assist pipelines use conversation.home_assis...

### `CRASH-ORPHAN-COMMITS-RECOVERY-1` - Terminal crash orphaned 14 develop commits — recovered and pushed — _WSJF 15.0 · v6 tc7 u2 /e1_
thread: **infra** - status: **done**
_created 2026-09-13 20:45 · updated 2026-09-13 21:15 · initial_
- **Problem / Solution:**
  - Problem: the terminal died mid-session for the second time, and the work from that session was sitting only on this machine — never pushed anywhere. Solution: check what local work had not reached the server, confirm it was intact, and p...
- **Origin:** 2026-09-13 - operator — "The terminal exited again. Try to recover your last work context."
- **Next:** DONE — develop synced with origin.
- **Parsimony:** [BUILD] Local work from the crashed session had not reached origin.
...
- **Forensic keys (13):**
  - `verify_2026_09_12`: APPROVED -> verify-before-work: the deliverable THIS card owned shipped (D1 clamp + guest-rooms-lead, v5.79.0) -> CLOSE. MEASURED: the residual census-NUMBER double-count is STILL live (people_home_census hit 6 on 09-08 and 4 repeatedly ...
  - `disposition_2026_09_12b`: APPROVED to work (operator board). Per verify-before-work: confirm the premise is STILL real (ground truth) BEFORE acting; if stale/already-done/moot, record + re-surface rather than build. Lane moves with the verification outcome.
  - `disposition_2026_09_12_sweep2`: INVESTIGATED verify-before-work sweep 2026-09-12 (agent-verified) STILL-REAL: guest-half fix shipped v5.79.0 (D1 clamp + guest-rooms-lead) mitigated guest-state harm, but the census NUMBER double-count is still open and face-recognition-...
  - `relane_2026_09_10`: Not a soak -> INVESTIGATING. Suite NAME-diff at tip was blocked by the (now-cleared) concurrent-pytest deadlock; re-run the framings against the repaired oracle.
...
### `ZIRI-COLLEGE-PERSISTENT-AWAY-1` - Ziri off to college — a resident is now persistently away (presence/census/schedule implications) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done** - approval: **explicit**
_created 2026-08-19 13:00 · updated 2026-09-12 19:05 · initial_
- **Problem / Solution:**
...
- **Forensic keys (5):**
  - `verify_2026_09_12`: APPROVED -> verify-before-work: NOT-A-DEFECT, persistent-away is handled gracefully. MEASURED: person.ziri=not_home (device_tracker.ziri_iphone BLE, in_zones:[]), correctly EXCLUDED from census (people_home_census=3, ziri_phone_left_behi...
  - `disposition_2026_09_12b`: APPROVED to work (operator board). Per verify-before-work: confirm the premise is STILL real (ground truth) BEFORE acting; if stale/already-done/moot, record + re-surface rather than build. Lane moves with the verification outcome.
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified): sub-item (c) persistent-absence state confirmed UNBUILT (0 hits long_term_absence). (a) stale-tracker anomaly + (b) return-guest-FP need live person/census checks — stays inv...
...
### `WATCHDOG-INERT-1` - Three of four v5.35.0 stuck-signal detectors are effectively inert (D3 structurally unreachable) — _WSJF 2.4 · v5 tc3 u4 /e5 ⚠_
thread: **presence** - status: **done** - approval: **explicit**
_updated 2026-09-12 18:55_
...
- **Forensic keys (22):**
  - `verify_2026_09_12`: APPROVED -> verify-before-work REFUTES the inert premise (operator: some look stale — this one was). MEASURED (URA DB anomaly_log + recorder): D1 camera_stuck is LIVE + firing CORRECTLY (7 all-time, 5 in 30d; most recent 2026-09-11) catc...
  - `disposition_2026_09_12b`: APPROVED to work (operator board). Per verify-before-work: confirm the premise is STILL real (ground truth) BEFORE acting; if stale/already-done/moot, record + re-surface rather than build. Lane moves with the verification outcome.
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) PARTIALLY-DONE: D3 resolved-by-removal (const.py:3885 tombstone, commit b9975cf30) — card already reflects this. Remaining open = D1/P24 silence measurement (correctly-rare vs...
...
### `REMINDER-ACTIVATE-OVERNIGHT-PASS-1` - Activate the overnight-pass launchd job (operator one-time launchctl load) — _WSJF 5.0 · v5 tc3 u2 /e2 ⚠_
thread: **tooling** - status: **done** - approval: **explicit**
_created 2026-09-12 16:30 · initial_
- **Problem / Solution:**
  - Problem: the nightly overnight-pass (drives the investigations lane while you sleep) is built and committed but NOT activated — activation is a deliberate operator step because it enables unattended autonomy. Solution: operator runs the ...
- **Next:** DO (operator, one-time): cp ~/Code/homelab-automation/launchd/com.phalanxmadrone.ura-overnight-pass.plist ~/Library/LaunchAgents/ && launchctl load ~/Library/LaunchAgents/com.phalanxmadrone.ura-overnight-pass.plist (then optionally launc...
- **Tags:** tier-1
- **Refs:** homelab-automation/scripts/overnight/ura_overnight_pass.sh; homelab-automation/launchd/com.phalanxmadrone.ura-overnight-pass.plist
- **Forensic keys (1):**
  - `activated_2026_09_13`: ACTIVATED 2026-09-13 21:35 on operator go ("Do it"). Ran the documented one-time install: cp ~/Code/homelab-automation/launchd/com.phalanxmadrone.ura-overnight-pass.plist ~/Library/LaunchAgents/ && launchctl load <same>. VERIFIED loaded ...
...
### `AC-RAMP-NO-RECURRENCE-ESCALATION-1` - The AC ramp-down nudges forever and never escalates — 47 "effective" nudges overnight while the house burned 49 kWh; hard reset has not fired since 2026-08-15 — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **done** - approval: **needs_operator**
_updated 2026-09-12 13:55_
...
- **Forensic keys (28):**
  ...
  - `reset_investment_answer_2026_09_12`: OPERATOR Q (is the reset investment worth it?) ANSWERED with a number -> NO for auto-escalation; CLOSE permanently. $-CEILING probe: nudge failure rate = 9/894 = 1.01% (28d; ~117/yr, forward ~50-60/yr non-z3 since z3 collapsing). Max rec...
  - `operator_2026_09_12`: Operator asks: is the RESET investment worth it? HONEST STATE: the reset MACHINERY is built, but its VALUE OVER NUDGES is UNPROVEN — nudges are 99% effective (879/888), resets are rare+inconclusive (7-9 organic), and the nudge-does-not-c...
  - `operator_decision_2026_09_12`: PARK for now as long as nudges keep working (operator). REVIVAL TRIGGER: if nudge effectiveness drops (ac_ramp_events nudge_evaluated effective=0 rate climbs materially above the current ~1%), revisit the deliberate hard-reset escalation...
  - `disposition_2026_09_12_sweep3`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) STILL-REAL, probe-gated NO-BUILD: go/no-go ESCALATION_PROBE not run (only 1/9 historical resets in the fine-grained window). Do NOT build a trigger before the probe returns re...
  - `measured_2026_09_12`: PROBE (URA DB ac_ramp_events, read-only via ssh): corroborates the card's existing bound — nudge_evaluated n=888 post-08-15 with effective=1 on 879 (99%), but that "effective" flag is the WRONG axis (the card already proved, power-side n...
  - `relane_2026_09_10`: Not a soak -> INVESTIGATING. Cheap discriminating query: does any post-08-15 nudge_evaluated carry effective=0 (decides one-defect-vs-two), then the design question for the operator.
...
### `AC-RAMP-ZONE3-NO-BENEFIT-1` - Zone 3 AC ramp shows NO measurable savings across 79 nudges — candidate for disable-pending-evidence rather than retune — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **done** - approval: **unreviewed**
_created 2026-08-21 11:40 · updated 2026-09-12 13:55 · initial_
...
- **Forensic keys (13):**
  - `verify_2026_09_12_probe`: MEASURED (approved probe) -> CLOSE accept-as-is. The net-90-min revival probe is UNRUNNABLE: z3 nudges fired 08-13..08-31 but recorder retains only 7d (earliest 09-05) and nudging COLLAPSED after threshold->2.2 (only 2 nudges since 09-01...
  - `operator_2026_09_12`: APPROVED to run the revival probe whenever (operator). KEY CONTEXT (operator): zone 3 is a TRANSIT zone — people pass through, do not dwell, so ramp benefit may genuinely be low because nobody stays to enjoy the pre-cool (reframes no-ben...
  - `verify_2026_09_12`: INVESTIGATE-flagged -> measured -> PARK (measure-before-build). ac_ramp_events (4160 rows, 30d): per-nudge effective rates z1 99.3% / z2 99.2% / z3 95.6%, and stored mean kwh_avoided z3=1.15 > z2=0.90 ~ z1=1.22 -> the in-table measure RE...
  - `disposition_2026_09_12b`: INVESTIGATE (operator board) — priority intake for the verify/measure sweep.
  - `needs_investigation`: True
  - `disposition_2026_09_12_sweep3`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) STILL-REAL: AC-ramp gate has no occupancy/preset input (hvac_override.py gates ramp/cooling/setpoint/kwh/sustain only). Measure-first: run the 79-nudge occupancy split before ...
...
- **Forensic keys (2):**
  - `disposition_2026_09_12_sweep4`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: perimeter_alert.py:646-663 re-runs SECC-1 sanity WARNING from READY handler after set_allowed_cameras (the only guard on normal boot ordering); silent early-retu...
...
### `AC-RESET-PRESET-ASSERT-DROPPED-1` - AC hard reset never restores a preset — the plan specified a one-liner, it was dropped without accounting, and it is the last path that can still strand a zone in manual — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **done** - approval: **unreviewed**
_created 2026-08-22 02:10 · updated 2026-09-12 11:15 · initial_
...
- **Forensic keys (5):**
  - `disposition_2026_09_12_sweep4`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: hvac_override.py:3822-3857 _verify_restore SUCCESS branch emits_set_preset_mode(original_preset) + F9 restore_ok=mode_ok AND preset_ok; commit a8e40ea97 shipped ...
  - `relane_2026_09_10`: Not a soak -> INVESTIGATING (trigger FIRED). Was blocked on v5.89.0 escalation mechanic not deployed; v5.89.0 is now live (we are at v5.100.8) so field evidence should exist. One-shot: query whether the AC-reset preset assert fired corre...
...
### `ARBITRAGE-GATE-D2-OFFBYONE-1` - Arbitrage gate pairs the peak-anchored target day with a HARDCODED classify_solar_day_n(2), so at offset 0 it forecasts today + D+2 and skips tomorrow — the same mis-pairing the drain path is fixing — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **approved**
_created 2026-08-24 19:20 · updated 2026-09-12 11:15 · initial_
- **Problem / Solution:**
...
- **Forensic keys (3):**
  - `disposition_2026_09_12_sweep4`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: energy_battery.py:2761/3187 call classify_solar_day_n(target_offset+1) not hardcoded n=2; commit f9825f833 shipped v5.91.2. Created the offset-0 self-pair edge n...
  - `relane_2026_09_10`: Not a soak -> PRE-PLANNING. Mirror the drain-fix offset+1 derivation (energy_battery.py:2454/:2871); 1 plan review, build, 3 reviews, deploy WITH dp-verypoor. Tier 2-DB.
...
### `DEVICE-ENTITY-REORG-1` - Device/entity de-fragmentation + nesting reorg (HA 2026.9) — the hub cycle that spawned the scale / helper-consolidation / per-item-reload follow-ups — _WSJF 0.8 · v5 tc3 u2 /e13 ⚠_
thread: **platform** - status: **done** - approval: **explicit**
_created 2026-09-03 16:50 · updated 2026-09-12 11:00 · refined_
- **Problem / Solution:**
...
- **Forensic keys (3):**
  - `disposition_2026_09_12_sweep3`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: Tier-3 device/entity de-frag shipped v5.94.0 (05692a0e7) + v5.94.1 fix-up incorporating Review D+C (6465e5841/085101e01); board reconcile 05017c589. No operator ...
  - `relane_2026_09_10`: Not a soak -> WAITING_OPERATOR. Tier-3 C+D reviews pending the operator adjudication set closing; state the falsifiable invariant, then operator checkpoint.
  - `spawns`: SCALE-LEAN-ROOM-PROFILE-1

### `SENSOR-CAPABILITY-1` - Separate sensor CAPABILITY (hardware kind) from analytic ROLE — kind is currently the config bucket — _WSJF 0.9 · v5 tc3 u4 /e13 ⚠_
thread: **presence** - status: **done** - approval: **explicit**
_updated 2026-09-12 11:00 · refined ×3_
...
- **Forensic keys (22):**
  ...
  - `disposition_2026_09_12_sweep3`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: capability layer shipped v5.65.0 AND wired — const.py:512 CONF_SENSOR_CAPABILITIES, sensor_capability.py, config_flow.py:110/10156, consumed coordinator.py:1735/...
  - `relane_2026_09_10`: Not a soak -> WAITING_OPERATOR. Plan written (docs/planning/PLANNING_sensor_capability_vs_role.md, Tier 3, 4 framing-disjoint reviews). Explicitly AWAITING OPERATOR GO (Tier-3 shared primitive, not implied-approval eligible).
...
### `NIGHT-LIGHT-NO-OFF-PATH-1` - A night_lights-only entity is never turned OFF by URA — the Master Bath under-cabinet light stays on 20-29h (all night AND day) until a human/device clears it — _WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
thread: **presence** - status: **done** - approval: **unreviewed**
_created 2026-08-31 18:35 · updated 2026-09-12 11:00 · initial_
- **Problem / Solution:**
...
- **Forensic keys (4):**
  - `disposition_2026_09_12_sweep3`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: automation.py:1040 _control_lights_exit unconditional CONF_LIGHTS ∪ NIGHT_LIGHTS off-set (Option A, operator correction 2026-09-01), shipped v5.92.1. A-vs-B ques...
  - `relane_2026_09_10`: Not a soak -> WAITING_OPERATOR. You pick intent (A vs B); then add night_lights OFF path mirroring CONF_LIGHTS exit (+ reconciler parity), preserving sleep-dim. Tier 2-DB.
...
### `TRANSIT-1` - Interior traversal — Protect-sourced checkpoints via resolver — _WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
thread: **presence** - status: **done** - approval: **explicit**
_updated 2026-09-12 11:00 · refined ×2_
...
- **Forensic keys (9):**
  - `disposition_2026_09_12_sweep3`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE (card 'not-shipped' was WRONG): build+3-reviewer fix-up merged (ab1135708/aea62bdcc/309aa4cc9); A-CRIT-1 core fix present transit_validator.py:697-715 (Protect se...
...
- **Forensic keys (5):**
  - `disposition_2026_09_12_sweep3`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: shipped v5.100.7 (34c4f9892, Tier-3, 3 reviews+mutation-verify); energy_const.py:348 DEFAULT_BATTERY_SOC_PRIMARY_MAX_AGE_S=300, _read_fresh_float at energy_batte...
  - `relane_2026_09_10`: Not a soak -> WAITING_OPERATOR. Needs your call: fix solar-only (narrow ENVOY-PRODUCTION-STALE-1) vs build the shared staleness helper + apply to all 4 frozen reads in one cycle. Then plan->review->build.
...
### `OPTIMIZER-COMFORT-HVAC-ZONE-MAPPING-FP-1` - Optimizer flags Study A + Study B + Master Bedroom on one thermostat zone as a comfort VIOLATION — but multiple house rooms on one HVAC zone is BY DESIGN — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **optimization** - status: **done** - approval: **unreviewed**
_created 2026-08-28 22:00 · updated 2026-09-12 11:00 · initial_
- **Problem / Solution:**
...
- **Forensic keys (3):**
  - `killed_2026_09_13`: KILLED by operator ("Yes but this is irrelevant. Reground yourself on design and kill this card. Its annoying"). OPERATOR ORACLE ANSWER RECORDED: Master Bedroom IS genuinely served by the studyb_zone_1 duct — NOT config drift. That settl...
...
### `CIRCLING-LABEL-1` - Circling loops page but are never LABELLED/escalated as circling (2-camera shape) — cooldown blocks the hop where classification forms — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **perimeter** - status: **done** - approval: **unreviewed**
...
- **Forensic keys (8):**
  - `disposition_2026_09_12_sweep2`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: exterior_track_linker.py:123 + perimeter_alert.py:1103/1258 cooldown-exemption (Option A) built/reviewed/shipped v5.76.0. Status was stale pre_planning.
  - `relane_2026_09_10`: Not a soak -> PRE-PLANNING. Future build (ura-planner -> plan review -> build).
...
### `DP-REASON-NULL-1` - DP durable ledger logs reason:null on all 4,181 rows — carrier has no .reason field — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **unreviewed**
_updated 2026-09-12 10:30_
...
- **Forensic keys (2):**
  - `disposition_2026_09_12_sweep2`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: energy.py:4177-4191 'DP-REASON-NULL-1:' reads last_eval_snapshot decision.reason into context; merged.
  - `relane_2026_09_10`: Not a soak -> PLANNED. Ready Tier-1 fix: log the eval-snapshot decision.reason (one line) + anchor test; fold into next deploy batch.

### `CONSOL-1` - Perimeter consolidation cycle — _WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
...
- **Forensic keys (4):**
  - `disposition_2026_09_12_sweep2`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) PARTIALLY-DONE->close primary: core alerting consolidation + llmvision enrichment shipped v5.73.0 (perimeter_alert.py:1426/1613; merge 4fd00c8de); SNAP-1 done. The three-stack...
  - `relane_2026_09_10`: Not a soak -> PRE-PLANNING. Future Tier-2-DB: fold SNAP-1 + TEST-1/2 in (NM channel consolidation).
...
### `CENSUS-TOGGLES-TO-DEVICE-SWITCHES-1` - Promote 3 Camera-Census feature toggles to device switches — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done**
_created 2026-08-18 03:10 · updated 2026-09-12 10:30 · refined_
...
- **Forensic keys (5):**
  - `disposition_2026_09_12_sweep2`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: switch.py:178 ura_presence_face_matching + ura_name_people_at_doors shipped v5.82.0 (Smart People Counting intentionally stays in options, revised scope). Status...
  - `relane_2026_09_10`: Not a soak -> PRE-PLANNING. Tier-2 plan: 3 SwitchEntity + persistence + options reconciliation, consumed by presence/transit/census. Plan review then build.
...
### `ENVOY-PRODUCTION-STALE-1` - Envoy solar-production sensor read 0 kW for ~16.5h while the house was exporting 6 kW — a stale live sensor that URA's solar entity derives from; does any decision path trust it? — _WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
thread: **energy** - status: **done** - approval: **unreviewed**
_created 2026-08-24 16:45 · updated 2026-09-12 10:30 · refined ×2_
- **Problem / Solution:**
...
- **Forensic keys (9):**
  - `disposition_2026_09_12_sweep2`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: clean-core solar read-gating shipped v5.93.1 (fbe57e782); consolidated net/battery/SOC staleness gate shipped v5.100.7 via FROZEN-POWER-READ-STALENESS-CLASS-1 (e...
  - `relane_2026_09_10`: Not a soak -> PLANNED (queued behind charge-onset; collides on energy files). Add last_updated staleness gate to _read_power_w (energy_battery.py:1572) mirroring battery_soc. Tier 2-DB.
...
### `DP-VERYPOOR-DRAIN-VALIDATOR-1` - On a "very poor" solar-forecast night the EV drain target comes from a value NO slider can change — the live-update validator accepts only 4 of the 5 forecast qualities — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
- **Forensic keys (4):**
  - `disposition_2026_09_12_sweep2`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: energy.py:9300 valid set includes very_poor in set_offpeak_drain; feature/dp-verypoor merged.
  - `relane_2026_09_10`: Not a soak -> PLANNED. Rebase/verify feature/dp-verypoor-drain-validator on develop, confirm 1-line + test green, merge + deploy alongside the arbitrage D2 ship.
...
### `DP-BATTERY-AUTHORITATIVE-TELEMETRY-1` - Surface DP + per-EVSE decision state as always-on authoritative telemetry (not disabled sensor / prose) — validation should read truth, not reconstruct it — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **implied**
_created 2026-08-25 21:30 · updated 2026-09-12 10:30 · refined_
- **Problem / Solution:**
...
- **Forensic keys (4):**
  - `disposition_2026_09_12_sweep2`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: sensor.py:10130 D6 always-on dp_state/soc/floor/age + :10184 D7 per-EVSE state/commanded_amps/actual_kw. Status was stale pre_planning.
  - `relane_2026_09_10`: Not a soak -> PRE-PLANNING. Inventory authoritative DP signals (command_trail, DP to_attrs, solar_follow_*) vs disabled/prose surfaces; spec always-on DP attrs + per-EVSE structure.
...
### `DELETE-REACT-DASHBOARDS-1` - Stop registering the dead React dashboards to the sidebar (phase 1, reversible) — code deleted in phase 2 — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **maintenance** - status: **done** - approval: **explicit**
_created 2026-09-09 09:10 · updated 2026-09-12 10:30 · refined ×1_
- **Problem / Solution:**
...
- **Forensic keys (3):**
  - `disposition_2026_09_12_sweep2`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE (phase-1 unregister): __init__.py:4149 React dashboards dead, no panel_custom/StaticPathConfig remain; shipped v5.100.5. Phase-2 dir deletion tracked by DELETE-RE...
...
### `AUTOKANBAN-SCHEMA-EXAMPLE-1` - auto-kanban references/schema example lacks rank:/links: blocks now that the skill documents them — _WSJF 4.0 · v3 tc3 u2 /e2_
thread: **tooling** - status: **done** - approval: **implied**
_created 2026-09-11 19:00 · updated 2026-09-12 10:15 · initial_
- **Problem / Solution:**
  - Problem: productmind-skills/skills/auto-kanban/references/schema/kanban.data.example.yaml does not demonstrate the new rank: and links: card blocks the SKILL.md now documents. Solution: add annotated rank:/links: examples to the schema f...
- **Next:** Add rank:/links: annotated examples to auto-kanban references/schema/kanban.data.example.yaml; commit+push productmind-skills.
- **Tags:** tier-1
- **Forensic keys (2):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) STILL-REAL: ~/Code/productmind-skills/.../kanban.data.example.yaml had zero rank:/links: keys. Tier-1 edit + push.
  - `disposition_2026_09_12_built`: SHIPPED 2026-09-12 (same turn): added rank: (WSJF value/time_criticality/effort/foundational) to EXPORT-1 + PERF-3, and links: (blocks/related/blocked_by + mandatory context) to EXPORT-1 + BACKUP-1 mirror, with the WSJF formula documente...

### `TEST-1` - Boot-time shadow diff (legacy vs resolver leg set) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
- **Forensic keys (3):**
  - `disposition_2026_09_15_ack`: DONE — operator acknowledged this work on the board (ack TEST-1), and verification confirms it is genuinely complete, not just accepted. The card's `next` was STALE: it still read as unshipped follow-on work, but the Boot-time shadow dif...
...
### `ZIRI3-UNCONFIG-1` - RECOVER (not unconfigure) Ziri 3 device from Ziri Bedroom entry (presence + moving_target + VEML7700 lux) — rides next deploy restart — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done** - approval: **explicit**
_updated 2026-09-12 09:30_
...
- **Next:** CLOSED 2026-09-12 — node recovered; no operator action outstanding.
...
### `ATTAIN-UNBOUNDED-RATE-WINTER-MASK-1` - [REFUTED / NOT-A-DEFECT] Attain unbounded rate extrapolation is CORRECT by design — attain projects to the next high-rate boundary (pre-sunset) and charges from GRID; bounding to solar-horizon would REGRESS the dark-window grid-charge case — _WSJF 2.2 · v6 tc3 u2 /e5_
thread: **energy** - status: **done** - approval: **unreviewed**
_created 2026-09-11 19:20 · updated 2026-09-11 20:10 · refined ×2_
- **Problem / Solution:**
...
thread: **energy** - status: **done** - approval: **unreviewed**
_created 2026-09-11 19:05 · updated 2026-09-11 19:20 · initial_
- **Problem / Solution:**
...
thread: **tooling** - status: **done** - approval: **explicit**
_created 2026-09-11 16:55 · updated 2026-09-11 19:00 · initial_
- **Problem / Solution:**
...
### `MEDIA-ROOM-BLINDS-OPENING-INVESTIGATE-1` - Media room blinds open on their own (new, unnerving) — audit the actor; operator worried recent device/reload work moved room-code behavior — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **diagnostics** - status: **done** - approval: **implied**
_created 2026-09-08 17:30 · updated 2026-09-11 18:50 · refined ×1_
- **Problem / Solution:**
...
### `EGRESS-IDENTITY-JOIN-GAP-1` - Face recognition works but egress crossings carry NO identity — person_entry_exit_events.person_id is 0 of 7010 rows all-time even post-Frigate-2-reconfig; the recognition->egress-event JOIN is unwired — _WSJF 2.2 · v5 tc3 u10 /e8 ⚠_
thread: **security** - status: **done** - approval: **unreviewed**
_created 2026-08-26 20:45 · updated 2026-09-11 18:50 · refined_
- **Problem / Solution:**
...
- **Forensic keys (14):**
  - `blocks_2026_09_15`: SECURITY-ENTRY-VERDICT-NAME-1
  - `mirror_note_2026_09_15`: blocks back-ref added during the 2026-09-15 hygiene sweep — SECURITY-ENTRY-VERDICT-NAME-1 declared blocked_by this card but the dependency was one-sided, so it was invisible from this side.
  ...
  - `relane_2026_09_10`: Not a soak -> INVESTIGATING. Read the person_entry_exit_events writer (grep the egress insert): does it (a) never receive recognized identity or (b) receive-but-drop it?
...
### `KANBAN-WSJF-RENDERER-1` - Implement WSJF ranking in kanban_render.py — compute + per-lane sort + show score/rank on every card — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **tooling** - status: **done** - approval: **explicit**
...
- **Forensic keys (1):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: WSJF scoring live in scripts/kanban_render.py (compute_wsjf, per-lane sort, badge); commits cf80c6211+c1e3c37ac. Status was stale 'in_progress'. rank: backfill h...
...
### `STEP-SHADOW-EVIDENCE-WATCH-1` - Check STEP shadow chatter evidence during nightly board maintenance (until 08-21 forcing gate) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **diagnostics** - status: **done** - approval: **unreviewed**
_created 2026-08-19 12:00 · updated 2026-09-11 16:20 · initial_
- **Problem / Solution:**
...
### `ROOM-NAME-DESYNC-RECOVER-1` - Recover stalled room-rename write-through build (worktree vanished, salvage branch exists) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **config** - status: **done**
_created 2026-08-18 16:40 · updated 2026-09-11 16:20 · initial_
...
### `HVAC-PRESET-RESTORE-MISS-1` - Zone 1 sat in a held manual setpoint through six hours of home_day — the house-state transition never wrote it back — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **done** - approval: **unreviewed**
_created 2026-08-20 14:15 · updated 2026-09-11 16:20 · initial_
- **Problem / Solution:**
...
### `GUEST-ROOM-LOCATION-MATCH-1` - Precondition for designating a guest room: person location must match CONF_ROOM_NAME (D2-INFO-2) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done** - approval: **unreviewed**
_updated 2026-09-11 16:16_
- **Problem / Solution:**
...
### `GUEST-COUNT-DEDUP-MIGRATE-1` - ZoneGuestCountSensor uses naive subtractive guest count — migrate to deduped union — _WSJF 2.4 · v5 tc3 u4 /e5 ⚠_
thread: **presence** - status: **done**
_created 2026-08-18 11:00 · updated 2026-09-11 16:16 · initial_
...
- **Forensic keys (6):**
  - `disposition_2026_09_12`: VERIFIED 2026-09-12 (verify-before-work sweep) — verdict ALREADY-DONE; status was STALE (pre_planning while the card already carried shipped_version v5.83.0 + "SHIPPED + LIVE"). Source confirms the migration landed: aggregation.py:6165 Z...
  - `relane_2026_09_10`: Not a soak -> PRE-PLANNING. Verify ZoneGuestCountSensor live-status, then migrate _get_guest_count (+binary_sensor.py:1584) to the deduped unidentified_count. Producer/consumer check first.
...
### `FAN-SUSTAINED-SHAKE-DEMOTE-1` - Fan-RUNNING sustained-shake mmWave demotion (transition gate is wrong shape) — STEP sibling — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done**
_created 2026-08-19 04:10 · updated 2026-09-11 16:16 · refined_
- **Next:** Scope with FAN-TRANSITION-COINCIDENCE-GATE-1 as one fan-suspect-ladder cycle (onset-gate + sustained-demote). Blocking observability precondition (FAN-RECHECK-OBSERVABILITY-1) is DONE. Reuse STEP SensorExclusionSet + fan_recheck_state.
- **Forensic keys (6):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: D2 sustain demotion coordinator.py:470-492 + 3411; commits 76a2ae50e/eac707767 (Tier-3). Card premise ('cannot cover SUSTAIN') predates D2.
  - `program`: sensor-trust-exclusion
...
### `FAN-TRANSITION-COINCIDENCE-GATE-1` - mmWave-only occupancy onset within ±N s of a fan speed/power transition = fan-suspect — route to the existing recheck ladder instead of granting occupancy — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done** - approval: **implied**
_created 2026-08-26 09:45 · updated 2026-09-11 16:16 · initial_
- **Problem / Solution:**
...
- **Forensic keys (1):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: coordinator.py:3382-3447 mmWave-sole creation suppression + FAN_TRANSITION_SUSPECT_WINDOW_S; commit b5f1cfa66 shipped v5.46.0.

### `PERIMETER-ALERT-NAME-PERSON-1` - Perimeter alerts should NAME the person (consume egress/face identity) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **security** - status: **done**
_created 2026-08-18 09:45 · updated 2026-09-11 16:14 · initial_
...
- **Forensic keys (7):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: perimeter_alert.py:1353-1410 appends 'Identified: <Name>' via census._resolve_face_legs; commit 8cdd2703a shipped v5.98.0. The residual 'Person Detected' at :370...
  - `relane_2026_09_10`: Not a soak -> INVESTIGATING (measure-before-build). Probe the REAL egress identity rate against the GARAGE + family-room entry path (not front door) + Protect named face via webhook.
...
### `RELOAD-WATCHDOG-HAZARD` - URA parent-entry reload cascades → event-loop stall → watchdog (~5min outage) — _WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
...
### `LOVELACE-V8-STALE-ENTITY-REFS-1` - v8 Residence bespoke room cards reference ~51 non-existent entities (pre-existing Entity-not-found in old cards) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `ENERGY-POOL-ACTUATION-NOT-IN-ACTIVITY-LOG-1` - Energy-pool controller (EVSE + L1 plug) actuations are not written to ura_activity_log, so charger pause/ensure-on decisions cannot be audited after the fact — _WSJF 2.2 · v5 tc3 u10 /e8 ⚠_
thread: **energy** - status: **done** - approval: **explicit**
...
### `LOVELACE-AUTO-ROOM-DASHBOARD-1` - URA v8 + v6 Lovelace dashboards do not reflect newly-added rooms -> auto-generate room cards so any new room appears automatically — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `ROOM-ZONE-FIELD-NO-SYNC-1` - Room Setup "Zone" field does not add the room to that zone — new rooms must be manually added in the Zone dialog — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `D3-CANONICAL-ALLOWLIST-BINARYSENSOR-1` - Pre-existing test failure: binary_sensor.py calls iter_canonical_hvac_zones outside the D3 allowlist — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `ENERGY-ENTITIES-UPDATE-DISPATCH-ERROR-1` - A listener on the ura_energy_entities_update dispatch raises every refresh (65x/5h), logged as Exception in _refresh — pre-existing, surfaced during v5.99.1 validation — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **unreviewed**
...
### `CM-CONFIG-FLOW-UX-SELECTORS-1` - CM options sub-editors (notifications volume + routing) still use crude raw-field/YAML inputs — upgrade to friendly selectors — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **config** - status: **done** - approval: **implied**
...
### `URA-INTEGRATION-ARRANGEMENT-1` - URA device representation rework (umbrella) — House>Rooms>Room tree, registry, reload-cascade perf, menu harmonization — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `ATTAIN-SOLAR-AGGRESSION-INVESTIGATE-1` - Attain grid-charges early and exports solar later — investigate whether it should wait for solar (findings captured, not built) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **unreviewed**
...
### `CM-CONFIG-FLOW-UX-1` - Coordinator-Manager config menu has 2 blank category rows and crude, unfriendly sub-editors — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **device-tree** - status: **done** - approval: **explicit**
...
### `EGRESS-EXIT-COMULTI-DEPART-1` - Name BOTH people when a couple leaves together — each BLE tracker already identifies its own person — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **identity** - status: **done** - approval: **explicit**
...
- **Forensic keys (3):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: retry-claim co-departure camera_census.py:1404-1407/4246; commits 677dfe901+07933907e shipped v5.97.1. Status was badly stale 'pre_planning'.
  - `relane_2026_09_10`: Not a soak -> PRE-PLANNING. Plan (prior-art: reuse EgressDirectionTracker row + v5.96.1 backfill; relax abstain-on-multiple, per-row claim, keep flap/sentinel/veto) -> plan-review.
  - `spawned_from`: EGRESS-EXIT-IDENTITY-BACKFILL-1

### `EC-SUBSWITCH-ASYNC-WRITE-THREAD-1` - EC sub-switch deferred-restore calls async_write_ha_state off the event loop — HA now escalates to ERROR — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **unreviewed**
...
### `EGRESS-SENSOR-READER-TZ-OVERCOUNT-1` - persons-entered/exited-today over-counts across restarts (local-midnight vs naive-UTC string compare) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **identity** - status: **done** - approval: **unreviewed**
_created 2026-09-05 22:20 · initial_
- **Problem / Solution:**
...
- **Forensic keys (2):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: sensor.py:4514/4648/4720 now naive-UTC-of-local-midnight before get_entry_exit_events_since; commit fa0dd8eca.
  - `relane_2026_09_10`: Not a soak -> PLANNED (BLE mop-up). Convert day-boundary to the column convention (naive-UTC of local-midnight) at sensor.py:4447 + :4559; test across a UTC-5 restart.

### `DEVICE-TREE-SWEEP-COUNTER-LIFETIME-LATCH-1` - The device-tree parent-link sweep stops self-healing after 3 tries for the whole session (same bug class as the face-health boot cache) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `DEVICE-TREE-TUPLE-UNPACK-CONSISTENCY-1` - Two device-identifier loops still 2-unpack (the v5.94.3 3-tuple bug pattern) — narrowed scope makes them latent, not live — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **device-tree** - status: **done** - approval: **unreviewed**
_created 2026-09-05 17:05 · initial_
- **Problem / Solution:**
...
### `EGRESS-BLE-PROVENANCE-GATE-DROPS-DEPARTURES-1` - The v5.95.0 BLE crossing-namer attaches nobody because its provenance gate structurally drops every departure — _WSJF 0.8 · v5 tc3 u2 /e13 ⚠_
thread: **identity** - status: **done** - approval: **explicit**
...
### `IDENTITY-FACE-HEALTH-BOOTCACHE-1` - Fail-safe robustness — the face-producer health entity is cached None at boot when Frigate lags URA, leaving corroboration inert all session — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **identity** - status: **done** - approval: **explicit**
...
### `IDENTITY-FUSION-PRODUCER-1` - Identity fusion producer — BLE-primary egress person_id + face corroboration + producer-outage fail-safe (D2/D3/D4) — _WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
thread: **identity** - status: **done** - approval: **explicit**
...
### `DEVICE-SHELL-CLEANUP-1` - v5.94.0 left 3 empty duplicate coordinator device records on the parent entry + a same-identifier nesting mis-wire — remove shells, fix the D-NEST sweep resolution — _WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
thread: **platform** - status: **done** - approval: **explicit**
...
### `MENU-ZONE-PICKER-1` - Zone instance-picker is a SelectSelector form, not a menu — convert manage_zones (and optionally ai_rule_list) to async_show_menu for chooser consistency — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **platform** - status: **done** - approval: **explicit**
...
### `SCALE-LEAN-ROOM-PROFILE-1` - Closets/hallways carry the full ~105-entity Smart Room profile — a lean profile for simple room types could cut ~1000+ registry rows (boot + .storage + registry-size lever) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **platform** - status: **done** - approval: **explicit**
...
- **Forensic keys (3):**
  - `disposition_2026_09_12b`: DECLINED (operator board 2026-09-12): SCALE-LEAN-ROOM-PROFILE not pursued — closed. (lean per-room-type entity profile; operator declined.)
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) static half: NO lean profile exists (CONF_ROOM_TYPE only a behavioral dial, never gates platform registration). Quantitative premise (~105 entities/closet) needs the .storage/...
  - `spawned_from`: DEVICE-ENTITY-REORG-1

### `FRIGATE-SUBLABEL-FACE-BRIDGE-1` - Frigate 0.17 recognizes resident faces but the NAME never reaches a URA-joinable entity — the real gate for the whole egress-identity (6.0.0) arc — _WSJF 2.4 · v5 tc3 u4 /e5 ⚠_
thread: **identity** - status: **done** - approval: **explicit**
...
- **Forensic keys (4):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE (bridge built): camera_census.py:4668 async_register_frigate_face_listener on <prefix>/tracked_object_update; commits 82ac6b8b9/3a48d8e09 shipped v5.97.0. The ATT...
  - `relane_2026_09_10`: Not a soak -> INVESTIGATING (measure). Probe frigate/events MQTT for person sub_labels (names + per-camera coverage + latency) via the existing frigate_mqtt bridge. Per memory, D1 bridge buildable now.
...
### `HA-2026-9-VIA-DEVICE-COMPAT-1` - HA 2026.9 broke ALL coordinator entities — deprecated `via_device` DeviceInfo param is now a hard error; every coordinator entity failed to add (live outage) — _WSJF 5.0 · v5 tc3 u2 /e2 ⚠_
thread: **platform** - status: **done** - approval: **explicit**
...
- **Forensic keys (2):**
  - `disposition_2026_09_10`: DONE — shipped v5.92.3 (deletions-only via_device fix). VERIFIED live: coordinator entities repopulated (queried 118 ura_*_coordinator_* entities live this session during the reload investigation). The 2026.9 breakage is resolved.
...
### `FORECAST-ACCURACY-UNKNOWN-MASK-1` - forecast_accuracy sensor reads 'unknown' while it actually means the forecaster is BADLY inaccurate (rolling accuracy <=0), masking a real signal — _WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
thread: **energy** - status: **done** - approval: **implied**
...
### `ROOM-AUTOMATION-MODE-SELECT-UNAVAILABLE-1` - All 38 per-room automation_mode selects read UNAVAILABLE house-wide (pre-existing >=1 day, not the v5.92.0 deploy) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done** - approval: **unreviewed**
...
### `EVSE-CHARGE-ONSET-TIME-1` - EVSE charge-onset gate — hold EV charging until the battery drain target is reached AND a configurable onset hour has passed (whichever is later) — _WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
thread: **energy** - status: **done** - approval: **explicit**
...
- **Forensic keys (2):**
  - `disposition_2026_09_10`: DONE — the onset-time gate SHIPPED and is live (onset=01:00, _evaluate_onset_gate + ura_ev_charge_onset_active; confirmed holding this session). Its live BUG (early release on CM reload) is tracked separately by EVSE-CHARGE-ONSET-NOT-HEL...
  - `priority`: high

### `BATTERY-RESERVE-CLOUD-ORACLE-FLAP-1` - MISDIAGNOSIS CORRECTED — 37% reserve is CORRECT EV-hold, not a stuck write; real residual = cloud-oracle flap pollutes write-verify diagnostics — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **unreviewed**
...
### `HVAC-CAMERA-FACE-ARRIVAL-SOURCE-1` - HVAC pre-arrival ignores the camera_face "who just arrived" signal — wire it in for faster zone preconditioning — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **done**
_created 2026-08-28 12:00 · updated 2026-08-29 13:20 · initial_
- **Problem / Solution:**
...
- **Forensic keys (6):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: hvac.py:530 _pre_arrival_sources includes camera_face; filter :3603; commit b142583bf shipped v5.98.0.
  - `relane_2026_09_10`: Not a soak -> INVESTIGATING. Confirm HVAC arrival source filter (hvac.py:529/977) + SIGNAL_PERSON_ARRIVING emit (presence.py:4702); scope whether camera_face should be gated.
  - `tier`: 1-2
...
### `EGRESS-IDENTITY-DASHBOARD-TILE-1` - Surface the egress observability attrs as a "who entered today, named" dashboard tile — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **dashboarding** - status: **done**
_created 2026-08-28 12:00 · updated 2026-08-29 13:20 · initial_
...
- **Forensic keys (6):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE (HA leg): docs/dashboards/egress_identity_yield_card.yaml (commit 8cdd2703a) shipped v5.98.0. If a PWA leg was in scope it belongs to the dashboarding workstream,...
  - `relane_2026_09_10`: Not a soak -> PLANNED. Build the tile against sensor.py:4260 attrs (egress_face_ids_active, egress_identities_stamped) + D3 attach/ambiguity signals. HA leg first, then PWA.
  - `tier`: 1
  - `threshold_status`: PROVISIONAL — no confidence gate today (display/notify class); operator to confirm no gate before build
  - `sequence`: 1
...
### `BORROW-BANKING-LEASE-NOT-RELEASED-1` - A banking borrow sat 2h past its lease expiry without release — nudge borrows return cleanly, banking did not — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **done** - approval: **needs_operator**
...
### `EGRESS-IDENTITY-PRODUCER-EMITS-NOTHING-1` - person_id has NEVER been populated — 0 of 6,763 rows across 5.5 months. The eight identity-consumer cards are blocked on a producer that emits nothing, not a sparse one. NO-GO. — _WSJF 3.6 · v5 tc3 u10 /e5 ⚠_
thread: **presence** - status: **done** - approval: **unreviewed**
...
### `PERSON-VISITS-WRITE-PAUSE-1` - person_visits writes appear to have paused ~5h while egress events keep flowing — latest entry_time lagged egress by ~5h at 2026-08-26 measurement; not yet diagnosed — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done** - approval: **unreviewed**
...
### `EVSE-SOLAR-IDLE-DERESERVE-1` - A finished/idle solar bay reserves ~1.44-2.88 kW that starves a charging sibling — de-reserve long-idle bays from the solar-follow parked floor WITHOUT removing them from the claim set — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **approved**
...
- **Forensic keys (2):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: energy_pool.py:4953-4972 long-idle de-reserve via SOLAR_FOLLOW_IDLE_DERESERVE_TICKS; commit 803f0e2b3 shipped v5.91.3 (write-back committed).
  - `relane_2026_09_10`: Not a soak -> PLANNED. Build per PLANNING_evse_solar_idle_dereserve.md: _notdraw_ticks counter (mirrors _stale_ticks), exclude long_idle from parked_w, skip write churn, knob + discriminating tests.

### `SENSOR-FANINDEP-1` - Role matrix needs a fan-independence axis — 10GHz motion-mmWave fleet is corroborator-grade for stuck but NOT for fan-demotion — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done** - approval: **explicit**
...
### `OFFPEAK-DRAIN-VERYPOOR-SLIDER-1` - No very_poor off-peak-drain Number entity — the 5th quality target is tunable via the validator now (DP-VERYPOOR) but has no operator slider — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **implied**
...
- **Forensic keys (2):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: number.py:73 OffPeakDrainNumber 'very_poor' + allowlist __init__.py:6529; commit 93e2af3c5 shipped v5.91.4.
  - `relane_2026_09_10`: Not a soak -> PLANNED. Add the 5th OffPeakDrain CONF+Number+dispatch+setup-loop+allowlist, mirroring the 4 existing sliders. Tier 2 (config round-trip).

### `AC-RAMP-SAVINGS-OVERSTATED-1` - AC-ramp kWh-avoided TECH_DEBT entry states the wrong bias direction — one-line doc correction (magnitude is NOT a defect; the figure is explicitly not billing-grade) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **unreviewed**
...
### `HVAC-EXCURSION-D1-BANKING-RELEASE-1` - HVAC banking excursions start and never end (2 open / 0 ended) — add a periodic auto-release sweep + stale-boot banking release so a borrowed thermostat always gets handed back — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
- **Forensic keys (3):**
  - `disposition_2026_09_10`: DONE — discriminator MET (queried hvac_excursion_events): banking excursions now CLOSE. Event 55 zone_2 banking started 09-10T00:01 ended 09-10T00:56, trigger=stale_boot_release, restore_ok=1 (also event 54). No stuck-open banking rows. ...
...
### `HVAC-GOVERNED-EXCURSION-1` - One governed-write primitive for all three thermostat axes — mode got hardened in v4.7.32, setpoints and presets never did, and the same call sites leak on the ungoverned axes — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **done** - approval: **needs_operator**
...
### `HVAC-GOVERNED-RESTORE-FAIL-TAIL-1` - ~4% of governed-write restores genuinely fail (immediate=0 AND delayed=0) — a small real tail behind HVAC-GOVERNED-EXCURSION-1 — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
- **Forensic keys (3):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: root cause classified (Carrier unreadable-at-settle ~1%); discharge exists hvac_excursion.py:344 _surface_restore_failure -> NM fire_stuck_signal kind='borrow_re...
...
### `EVSE-DRAIN-PRECEDENCE-KNOB-80-1` - ROOT CAUSE (code-verified) — DP drain target MIS-SOURCED: drains toward static manual _ev_battery_drain_soc (80), NOT the forecast-based off-peak target (10) as designed — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **explicit**
...
- **Forensic keys (41):**
  ...
  - `disposition_2026_09_10`: DONE (met-with-residual). Primary discriminator already validated (per card). Residual (INV-DP-DRAIN-1e 2-tick no-flap release at drain-window-end) NOT exercisable — no drain_release event in ura_activity_log since 09-06 (no drain-window...
...
### `NEXT-ACTION-ESTIMATE-NAIVE-TARGET-1` - Battery strategy next_action_estimate reports naive single-day drain target (10) while the real composed floor is 15 — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **implied**
...
### `EVSE-SOLAR-FOLLOW-AMPS-1` - Charge current is binary (48A or off) so solar charging yo-yos the house battery: add excess-following current modulation on the two L2 EVSEs — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **explicit**
...
- **Forensic keys (16):**
  ...
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE (D1): SolarFollowController energy_pool.py:4440 wired energy.py:553/1369; commit 856a69418. Card 'awaiting operator go' was stale. If PLANNING_evse_solar_follow_a...
  - `relane_2026_09_10`: Not a soak -> PLANNED. Build-ready (PLANNING_evse_solar_follow_amps.md Rev-20). Ships AFTER the DP fix. Tier 3: four framing-disjoint reviews.
...
### `DASH-SOLAR-EV-CENSUS-1` - Enrich v6+v8 dashboards: Solar-Aware EV panel + v8 House Census (counts + per-person path & predicted next room) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `CARRIER-STALE-POLL-REFRESH-1` - ha_carrier goes stale for up to 1.8h and only a RELOAD clears it — operator asked for a periodic refresh; CUT from the pipeline-hardening cycle, carded so the request is not dropped — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **done** - approval: **unreviewed**
...
- **Forensic keys (13):**
  - `disposition_2026_09_10`: DONE (superseded). This was the pre-build probe to CHOOSE the Carrier stale-recovery approach; the decision (bounded reload) was made + BUILT + shipped as the Carrier stale-detect->reload cycle (hvac.py _reload_ha_carrier_entry, task #33...
...
### `D3-AREA-INHERIT` - URA D3 fused sensor should inherit room area on creation — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **camera** - status: **done** - approval: **implied**
...
### `RAMP-GATE4-HVAC-ACTION-LEVER-LEAK-1` - Ramp detection is vetoed by hvac_action == cooling — a CLOUD-REPORTED CLAIM gating a power-based feature. Measured: Bryant reported idle for 18 min while drawing 4.2 kW. — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **done** - approval: **unreviewed**
...
- **Forensic keys (8):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: D-GATE4 SPAN-draw predicate hvac_override.py:1634, default LIVE (hvac_const.py:716); select.ura_hvac_ac_gate4_predicate_mode exposed. Commit 6a97b67df, shipped v...
  - `relane_2026_09_10`: Not a soak -> INVESTIGATING. Needs the sizing probe: per zone, share of time-above-threshold vetoed by hvac_action != cooling, and the subset also at/below setpoint (the costly modulation subset).
...
### `NM-RECOVERY-AGEBOUND-1` - Boot recovery resurrects unacked CRITICALs of ANY age — 326 historical twin-eaten rows are a resurrection minefield — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **notifications** - status: **done** - approval: **unreviewed**
_updated 2026-08-23 14:30_
...
### `OPT-META-BOOT-TRANSIENT-1` - Optimizer meta-monitor false "cannot see problems" alert — findings_recent reads RAM cache emptied by restart while open-count reads durable state — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `DIMMER-REBOOT-1` - Master bedroom Shelly Dimmer 2 reboots 89x since Aug 1 and returns ON (NOT thermal) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `SNAP-1` - Snapshot mirror-and-improve — _WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
thread: **perimeter** - status: **done** - approval: **explicit**
...
### `KHOST-1` - Homelab-hosted board, generated from data — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **dashboarding** - status: **done** - approval: **explicit**
_updated 2026-08-23 14:30_
...
### `CENSUS-FACE-RESOLVER-MIGRATE-1` - Route presence face-confirmed-arrival through the _2-suffix resolver (bucket-2 wire) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done**
...
### `BORROW-FRIENDLY-NAME-RENAME-1` - Rename user-facing "Governed thermostat borrows" labels — ship with next batch — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `D2-CANARY-GUEST-PREDICATE-1` - URA's own planted tripwire is firing ~4x/min saying the guest-arming logic was re-composed — 3300+ hits since boot, nobody notified — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done** - approval: **explicit**
...
### `SENSCAP-ORPHAN-1` - A room sensor can never be removed once capabilities are in play — the stale per-entity dropdown re-injects an orphan declaration and wedges the form permanently — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `KITCHEN-OCCUPANCY-DEAD-1` - RESOLVED — NOT A DEFECT: kitchen occupancy is pinned off by switch.kitchen_override_vacant (room deliberately disabled); three inferred mechanisms were wrong before the switch was checked — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `HVAC-TUNABLE-RUNTIME-NOT-SEEDED-1` - The 14 HVAC tunable Numbers display the operator's value but the coordinator runs the DEFAULT until someone touches the knob — a nudge after a restart used 300s, not the configured 120s — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **done** - approval: **explicit**
...
- **Forensic keys (9):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: __init__.py:6197 _seed_hvac_runtime_tunables_from_options() called at CM setup :3742 (commits 25ef9ab0d/98636ebf5). Discriminator if desired: number.ura_hvac_ac_...
  - `relane_2026_09_10`: Not a soak -> PLANNED (operator-approved fix-in-cycle). (a) SEED RUNTIME FROM OPTIONS AT SETUP for all 14 factory tunables at the factory/CM-setup level (not 14 hand seeds); (b) the paired deliverable.
...
### `EGRESS-CAMERA-DEAD-CONFIG-1` - Two of five egress cameras are configured under dead Frigate-1 names — Garage A and Garage B contribute nothing to egress detection, on the house's primary entry path — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `EV-GARAGE-A-NOCHARGE-1` - BMW on Garage A refuses charge overnight — vehicle-side or pilot fault; URA exonerated — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **unreviewed**
...
### `HVAC-STALE-ACTUATOR-FRESHNESS-1` - A thermostat can go stale-but-"available" and URA keeps deciding on 90-minute-old data with nothing flagging it — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **done** - approval: **explicit**
...
### `SENSOR-HEALTH-SURFACING-1` - Sensor health: chatter QUARANTINE (untrust from occupancy fusion) — trust model — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
- **Forensic keys (17):**
  - `disposition_2026_09_12_sweep`: VERIFIED verify-before-work sweep 2026-09-12 (agent-verified) ALREADY-DONE: STEP chatter-quarantine shipped v5.85.0 (07b3ad116; chatter_detector.py+sensor_exclusion.py). Open tail already carded as CHATTER-OBSERVE-CONTROL-D7-1 + CHATTER-...
...
### `FAN-RECHECK-OBSERVABILITY-1` - Surface fan-recheck veto reasons + eval counts + D2 demotion state (recheck non-arm is invisible) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done**
...
### `STUDYA-ZIGBEE-MMWAVE-MISCATEGORIZED-1` - Study A Zigbee mmWave mapped as motion_sensors — motion>presence precedence blocks recheck when it fires — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done**
...
### `FAN-RECHECK-NOT-CLEARING-1` - Fan-interference recheck not clearing held rooms — fans should pause to unhold, not happening — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done**
...
### `CENSUS-IDENTITY-GROUP-README-1` - Cycle-group README: census/guest/presence-identity program — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `CENSUS-IDENTITY-SUPERSESSION-DELETE-1` - Delete superseded census/identity code (gated on L3 validation) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **planning** - status: **done**
...
### `D3-BEHAVIOURAL-COVERAGE-1` - D3 guest-room registry resolution has ZERO behavioural coverage — all six tests are source-shape — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done** - approval: **unreviewed**
...
### `MEMORY-PROGRAM-EPIC` - EPIC — Hierarchical Entity Memory: every node (room/zone/house/coordinator) owns consultable, compressed history behind one queryable interface — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `MEMORY-WRITERS-1` - Memory episode-writer coverage gaps — writers ride the detectors, so memory is blind where detectors fail (retro: 0 FULL / 2 PARTIAL / 2 NONE) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `IMSG-IMAGE-FAIL-1` - iMessage security images NOT arriving (organic FAIL of NM-BB-IMAGE-1 L5) + [audit] sentinel leaking into operator-visible message bodies — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **notifications** - status: **done** - approval: **unreviewed**
...
### `NM-BB-IMAGE-1` - iMessage photo delivery unblocked — BlueBubbles v0.5/0.6 added attachment + media_url — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `PLAN-TIER-1` - Tiered PLAN reviews: quality up front — plans reviewed before builds, like builds — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `DOC-DRIFT-ZONE-AWAY-1` - Coordinator manuals stale vs code on zone-away / away-veto (PRESENCE_COORDINATOR.md badly stale) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `GUEST-ROOM-CONFIG-1` - Guest-room designation was wrong: a BATHROOM was flagged is_guest_room (unflagged 2026-08-17) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done** - approval: **explicit**
...
### `MEMORY-COMPACTOR-1` - Hierarchical memory — build the deferred daily compaction batch when memory_episodes has volume (trigger: any episode type >50 rows) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **memory** - status: **done** - approval: **explicit**
...
### `FAN-LAYER-1` - DOC-2 fan-actuation shared layer: REVIVED — FAN-MANUAL-1 fired 3 of its 4 park triggers — _WSJF 0.8 · v5 tc3 u2 /e13 ⚠_
thread: **hvac** - status: **done** - approval: **explicit**
...
### `CAM-AREA-PENDING` - Camera area corrections — RESOLVED — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `v5.59.0` - resolver-legs — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **perimeter** - status: **done**
_updated 2026-08-17 23:30_
...
### `BOARD-CURRENCY-1` - Forcing-function ladder so the board (and vibememo) cannot lag shipped work — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **process** - status: **done** - approval: **explicit**
...
### `ARREST-COMFORT-1` - Override arrester reverts occupant manual cooling requests with no comfort exemption — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **done** - approval: **approved**
...
### `BLE-WARM-CREATE-1` - BLE re-creates bathroom occupancy inside the 10-min warm window on every toilet visit (v5.22.0 left this open by design) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done** - approval: **unreviewed**
...
### `FAN-MANUAL-1` - Fans have no manual-ON override: room temp logic reverts a hand-switched fan ("below threshold") — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **done** - approval: **explicit**
...
### `FRIGATE-RETIRE-1` - Retire Frigate-1 — promote Frigate-2 (yolov9t/OpenVINO, zero night ghosts) to primary incl. snapshot engine — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `PWA-CONTROL-LIST-1` - Per-room controllable-entities attr so the PWA stops slugify-guessing actuators (AV-Closet-Shelly problem) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `ZONE-CAM-PERSON-GUARD-1` - Durable device_class guard so a Frigate MOTION sensor cannot be trusted as camera person-confirmation in zone occupancy-confidence — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done** - approval: **unreviewed**
_refined ×1_
...
### `CENSUS-SUFFIX-FIX-1` - Census regression ROOT-CAUSED: strict-suffix matchers miss all _2 F2 sensors since F1 death (08-13) -> count sensors unmapped -> census pinned at identified count. Fix: disambiguation-tolerant matching. — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **done** - approval: **implied**
...
### `MDNS-SERIAL-HOSTS-1` - mDNS-serial hostnames breaking cross-VLAN camera consumers — amcrest FIXED; audit F2 RTSP paths + any other serial-host configs — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **devices** - status: **done** - approval: **implied**
...
### `MEMORY-FIRST-DIAGNOSTICS-1` - Memory-first diagnostics doctrine — memory_query is the FIRST surface checked in any investigation/trace, encoded in memory + skills — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **memory** - status: **done** - approval: **explicit**
...
### `MEMORY-RETRO-VALUE-1` - Retro-check — which answers in the last few investigations were already derivable from memory_episodes? — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **memory** - status: **done** - approval: **explicit**
...
### `GARAGE-EGRESS-APPLY-1` - APPLY the 2026-08-10 garage-camera ruling — garage_a/garage_b into CONF_EGRESS_CAMERAS at the NEXT deploy restart (operator said do not forget) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **security** - status: **done** - approval: **approved**
...
### `SUITE-HYGIENE-1` - Kill the order-dependent flake families (sys.modules pollution) — every cycle pays a classification tax — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `NM-IMAGE-1` - NM image attachments not landing (WhatsApp + iMessage) — operator automation images DO land — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **notifications** - status: **done** - approval: **unreviewed**
...
### `DP-OBSERVABILITY-1` - DP plan sensor presents stale eval snapshot as current (misled 2 diagnoses in one day) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **energy** - status: **done** - approval: **unreviewed**
...
### `TEST-2` - "Send Test Perimeter Alert" button — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `FRIG2SNAP-1` - frigate2 instance-id snapshot URL — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **camera** - status: **done** - approval: **implied**
...
### `KP-ESCALATE-1` - Known-person / face-alert path (no URA successor) — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `F1-SUNSET` - Frigate-1 go/no-go — _WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
