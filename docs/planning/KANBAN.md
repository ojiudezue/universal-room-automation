...
_Generated: 2026-09-18T17:45:08-05:00_ - _Data commit: `b5cab2281ef1`_ - _last_reconciled: 2026-09-18_
...
### `STUCK-MOTION-FROZEN-ON-BLINDSPOT-1` - Stuck-sensor defense is blind to a MOTION/PIR sensor frozen ON (offline holding last state) — trusted anchor + unavailable-only staleness let a phantom hold the house occupied — _#1 · WSJF 2.4 · v5 tc3 u4 /e5 ⚠_
