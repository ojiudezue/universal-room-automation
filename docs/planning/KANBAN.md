...
_Generated: 2026-09-12T03:33:24-05:00_ - _Data commit: `de9e3af5308a`_ - _last_reconciled: 2026-09-11_
...
### `PATHBETA-VESTIGIAL-1` - Path-beta infrastructure is now dead-code-like after D2b — scoped cleanup (reviewer B: do NOT bundle into PATH-ALPHA) — _#10 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **pre_planning** - approval: **unreviewed**
...
### `TABLET-FLEET-1` - Wall tablet fleet: URA integration (sensors, wake-on-occupancy, room quick-actions) — _#11 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `TEST-1` - Boot-time shadow diff (legacy vs resolver leg set) — _#12 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `EC-SOC-LADDER-XVALIDATE-1` - No cross-field validation on the EC SOC ladder — inverted operator sliders can flip a gate polarity and oscillate EV pause/resume; the parked fix's trigger has now fired — _#13 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `BLE-BLEED-EXTEND-SLEEP-1` - Master Bath held occupied all night (441 min) by BLE bleed from the adjacent bedroom, with zero body corroboration — a genuine vacancy EXTEND while residents sleep — _#14 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **pre_planning** - approval: **unreviewed**
...
### `CENSUS-ACCURACY-1` - Interior census accuracy: separate census decay from guest hysteresis + fix the _2-suffix fresh-face resolution (exterior dashboard wiring is a minor bonus) — _#15 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `APPLIANCE-COST-DEFERRAL-1` - Appliance cost-deferral — LG ThinQ + Rainbird start-deferral/skip — _#16 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `SUITE-ORDER-POLLUTION-1` - Presence tests fail order-dependently in large batches (suite hygiene) — _#19 · WSJF 1.9 · v8 tc3 u4 /e8_
thread: **platform** - status: **pre_planning**
...
### `HVAC-BASELINE-MAXSAMPLES-1` - HVAC anomaly baselines never forget — an accumulator matured on August cooling will misjudge October; scope a bounded/windowed sample count into the shared detector — _#20 · WSJF 1.2 · v5 tc3 u2 /e8 ⚠_
thread: **hvac** - status: **pre_planning** - approval: **explicit**
