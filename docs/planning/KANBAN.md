...
### `EGRESS-IDENTITY-JOIN-GAP-1` - Face recognition works but egress crossings carry NO identity — person_entry_exit_events.person_id is 0 of 7010 rows all-time even post-Frigate-2-reconfig; the recognition->egress-event JOIN is unwired — _#5 · WSJF 2.2 · v5 tc3 u10 /e8 ⚠_
...
### `ZIRI-COLLEGE-PERSISTENT-AWAY-1` - Ziri off to college — a resident is now persistently away (presence/census/schedule implications) — _#8 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **investigating** - approval: **unreviewed**
...
### `RAMP-GATE4-HVAC-ACTION-LEVER-LEAK-1` - Ramp detection is vetoed by hvac_action == cooling — a CLOUD-REPORTED CLAIM gating a power-based feature. Measured: Bryant reported idle for 18 min while drawing 4.2 kW. — _#12 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **investigating** - approval: **unreviewed**
...
### `AC-RAMP-NO-RECURRENCE-ESCALATION-1` - The AC ramp-down nudges forever and never escalates — 47 "effective" nudges overnight while the house burned 49 kWh; hard reset has not fired since 2026-08-15 — _#13 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `AC-RESET-PRESET-ASSERT-DROPPED-1` - AC hard reset never restores a preset — the plan specified a one-liner, it was dropped without accounting, and it is the last path that can still strand a zone in manual — _#14 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **hvac** - status: **investigating** - approval: **unreviewed**
...
### `NM-REPAGE-IMG-1` - Re-attach stored snapshot on CRITICAL re-pages — text-only repeats are a correctness bug, not a design choice — _#15 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `HVAC-GOVERNED-RESTORE-FAIL-TAIL-1` - ~4% of governed-write restores genuinely fail (immediate=0 AND delayed=0) — a small real tail behind HVAC-GOVERNED-EXCURSION-1 — _#16 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `NM-BB-CHATGUID-SELFSEND-1` - BlueBubbles v0.7.0 adds send-by-chat-GUID — lets NM target a chat by GUID instead of address, decoupling alert sends from the iMessage account so URA stops messaging the operator's own thread — _#17 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `HVAC-CAMERA-FACE-ARRIVAL-SOURCE-1` - HVAC pre-arrival ignores the camera_face "who just arrived" signal — wire it in for faster zone preconditioning — _#19 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `WATERLEAK-TRIO-UNKNOWN-1` - Three water-leak sensors (laundry, upstairs-guest bath, Ziri bath) all went unknown together at 08-30 16:46 — one event, safety — _#20 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **investigating** - approval: **unreviewed**
...
### `SCALE-LEAN-ROOM-PROFILE-1` - Closets/hallways carry the full ~105-entity Smart Room profile — a lean profile for simple room types could cut ~1000+ registry rows (boot + .storage + registry-size lever) — _#21 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `CENSUS-FACE-MISS-WATCH-1` - Census face-lookup misses ~12/tick on an empty house — investigate on occupancy — _#22 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **presence** - status: **investigating** - approval: **unreviewed**
...
### `URA-CONFIG-ENTRY-RELOAD-STORM-1` - The COORDINATOR-MANAGER (CM) config entry reloads itself ~5x/night with no operator change — 118 coordinator entities blip unavailable each time (root of the onset early-release + parent-reload watchdog risk) — _#23 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `PERIMETER-ALERT-NAME-PERSON-1` - Perimeter alerts should NAME the person (consume egress/face identity) — _#24 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `GUEST-FALSE-POSITIVE-JAYA-ONLY-1` - House flips to GUEST when only a single resident (Jaya) is home — _#25 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `GUEST-IDENTITY-PHONE-LEFT-BEHIND-1` - Guest-room identity exclusion is BLE-only, so a resident without their phone arms GUEST after 30 min — _#26 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `GUEST-GATE-DOOR-IDENTITY-1` - Guest gate should consume door-identity (not just BLE room-location) — _#27 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `TEST-STRATEGY-REARCH-1` - Investigate + possibly re-architect the automated test strategy (never examined; slow + collides + hollow at boundaries) — _#28 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
...
### `OPTIMIZER-NOTIFY-FLOOD-DEDUP-1` - Optimizer comfort finding re-sends 8+ identical alerts back-to-back — no per-finding dedup / cooldown on the notification path spams the operator — _#29 · WSJF 2.0 · v5 tc3 u2 /e5 ⚠_
thread: **notifications** - status: **investigating** - approval: **unreviewed**
...
### `PERIMETER-PHANTOM-XCORR-1` - Perimeter person alerts fire with no person in the snapshot, sent twice, and not cross-checked across NVRs — _#30 · WSJF 0.8 · v5 tc3 u2 /e13 ⚠_
thread: **security** - status: **investigating** - approval: **unreviewed**
