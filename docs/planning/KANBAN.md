...
- **Forensic keys (6):**
  ...
  - `OPERATOR_CHOSE_A_TIMER_2026_08_21`: DECIDED — operator: "Give it a timer." The ending is a BOUNDED TIMER, not the off-phase-expiry discharge originally proposed below. THIS IS THE LOWER-RISK CHOICE and supersedes part (1) of the three-part proposal: off-phase-expiry would ...
