...
_Generated: 2026-08-10T11:27:20-05:00_ - _Data commit: `d765265a03f8`_ - _last_reconciled: 2026-08-10_
...
- **Next:** BUILD IN FLIGHT (Tier-3 bar): deletion + two mandatory verifications (tick-ordering mutation test as go/no-go; no-mmWave room enumeration for reviewers) + falsifiable-invariant regression anchors (BLE must never create at ANY motion age)...
