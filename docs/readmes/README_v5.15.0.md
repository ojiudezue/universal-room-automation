...
| L5 | No flapping at the floor ≥1h | **PASS (verified 01:17)** | Recorder shows a single ON edge (00:11:01) and zero further transitions through 01:17 — 65+ min continuously charging. Sticky band + release working with no oscillation. |
